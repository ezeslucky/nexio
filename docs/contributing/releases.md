...
Trigger a release action in the [Release Desktop App](https://github.com/ezeslucky/nexio/actions/workflows/release-desktop-app.yml).
...
Once the release action is complete, a draft release will appear on the [Releases page](https://github.com/ezeslucky/nexio/releases).
