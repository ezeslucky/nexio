import type { Store, TransformerMiddleware } from '@blocksuite/nexio/store';
import {
  type HtmlAdapter,
...
export const NEXIO_ADAPTER_PANEL = 'nexio-adapter-panel';
  ...
  override render() {
    return html`
      <div class="adapters-container">
        <nexio-adapter-panel-header
          .updateActiveContent=${this._updateActiveContent}
        ></nexio-adapter-panel-header>
        <nexio-adapter-panel-body></nexio-adapter-panel-body>
      </div>
    `;
  }
...
declare global {
  interface HTMLElementTagNameMap {
    [NEXIO_ADAPTER_PANEL]: AdapterPanel;
  }
}
