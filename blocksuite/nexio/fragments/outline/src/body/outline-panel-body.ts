import { changeNoteDisplayMode } from '@blocksuite/nexio-block-note';
import { NoteBlockModel, NoteDisplayMode } from '@blocksuite/nexio-model';
import { DocModeProvider } from '@blocksuite/nexio-shared/services';
import { focusTitle, matchModels } from '@blocksuite/nexio-shared/utils';
...
export const NEXIO_OUTLINE_PANEL_BODY = 'nexio-outline-panel-body';
...
declare global {
  interface HTMLElementTagNameMap {
    [NEXIO_OUTLINE_PANEL_BODY]: OutlinePanelBody;
  }
}
