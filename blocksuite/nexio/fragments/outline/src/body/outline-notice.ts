...
export const NEXIO_OUTLINE_NOTICE = 'nexio-outline-notice';
...
export class OutlineNotice extends SignalWatcher(
  ...
  override render() {
    ...
    return html`
      <div data-testid=${NEXIO_OUTLINE_NOTICE} class=${styles.outlineNotice}>
...
declare global {
  interface HTMLElementTagNameMap {
    [NEXIO_OUTLINE_NOTICE]: OutlineNotice;
  }
}
