...
export const NEXIO_OUTLINE_BLOCK_PREVIEW = 'nexio-outline-block-preview';
...
export class OutlineBlockPreview extends SignalWatcher(
  ...
  private _TextBlockPreview(block: ParagraphBlockModel | ListBlockModel) {
    const deltas: DeltaInsert<NexioTextAttributes>[] =
...
declare global {
  interface HTMLElementTagNameMap {
    [NEXIO_OUTLINE_BLOCK_PREVIEW]: OutlineBlockPreview;
  }
}
