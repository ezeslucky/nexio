import { type NoteBlockModel, NoteDisplayMode } from '@blocksuite/nexio-model';
...
export const NEXIO_OUTLINE_NOTE_CARD = 'nexio-outline-note-card';
    ...
    this.disposables.add(
      std.dnd.draggable<NoteCardEntity>({
        ...
        setDragPreview: ({ container, setOffset, location }) => {
          const preview = document.createElement(NEXIO_OUTLINE_NOTE_CARD);
...
declare global {
  interface HTMLElementTagNameMap {
    [NEXIO_OUTLINE_NOTE_CARD]: OutlineNoteCard;
  }
}
