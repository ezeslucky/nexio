...
export const NEXIO_OUTLINE_NOTE_PREVIEW_SETTING_MENU =
  'nexio-outline-note-preview-setting-menu';
...
declare global {
  interface HTMLElementTagNameMap {
    [NEXIO_OUTLINE_NOTE_PREVIEW_SETTING_MENU]: OutlineNotePreviewSettingMenu;
  }
}
