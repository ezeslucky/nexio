import { NoteDisplayMode } from '@blocksuite/nexio-model';
...
export const NEXIO_OUTLINE_VIEWER = 'nexio-outline-viewer';
...
export class OutlineViewer extends SignalWatcher(
  ...
  static override styles = css`
    ...
    .outline-viewer-indicator {
      ...
      border-radius: 1px;
      overflow: hidden;
      background: var(--nexio-black-10, rgba(0, 0, 0, 0.1));
    }

    .outline-viewer-indicator.active {
      width: 24px;
      background: var(--nexio-text-primary-color);
    }
...
declare global {
  interface HTMLElementTagNameMap {
    [NEXIO_OUTLINE_VIEWER]: OutlineViewer;
  }
}
