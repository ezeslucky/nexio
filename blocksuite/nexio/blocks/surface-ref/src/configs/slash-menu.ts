...
import { EdgelessCRUDExtension } from '@blocksuite/nexio-block-surface';
import { MindmapStyle, SurfaceRefBlockSchema } from '@blocksuite/nexio-model';
import {
  type SlashMenuActionItem,
  type SlashMenuConfig,
  SlashMenuConfigExtension,
  type SlashMenuItem,
} from '@blocksuite/nexio-widget-slash-menu';
