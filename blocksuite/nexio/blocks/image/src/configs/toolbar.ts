import { updateBlockAlign } from '@blocksuite/nexio-block-note';
import { ImageBlockModel, TextAlign } from '@blocksuite/nexio-model';
import {
  ActionPlacement,
      ...
      actions: [
        {
          ...
          when(ctx) {
            const supported =
              ctx.store.schema.flavourSchemaMap.has('nexio:attachment');
