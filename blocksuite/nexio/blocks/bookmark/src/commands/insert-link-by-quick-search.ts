import { insertEmbedIframeWithUrlCommand } from '@blocksuite/nexio-block-embed';
import {
  type InsertedLinkType,
  insertEmbedLinkedDocCommand,
  insertEmbedSyncedDocCommand,
  type LinkableFlavour,
} from '@blocksuite/nexio-block-embed-doc';
import {
  DocModeProvider,
  ...
  const insertedLinkType: Promise<InsertedLinkType> = quickSearchService
    ...
    .then(result => {
      ...
      if ('docId' in result) {
        ...
        let flavour: LinkableFlavour = 'nexio:embed-linked-doc';
