...
import { reassociateConnectorsCommand } from '@blocksuite/nexio-block-surface';
...
import { getBlockProps } from '@blocksuite/nexio-shared/utils';
...
const previewAction = {
  ...
  content(ctx) {
    ...
    return html`<nexio-link-preview .url=${url}></nexio-link-preview>`;
  },
  ...
  actions: [
      ...
      actions: [
        {
          ...
          run(ctx) {
            ...
            ctx.store.addBlock('nexio:paragraph', { text }, parent, index);
    ...
    } satisfies ToolbarActionGroup<ToolbarAction>,
    {
      ...
      content(ctx) {
        ...
        return html`${keyed(
          model,
          html`<nexio-card-style-dropdown-menu
            @toggle=${onToggle}
            .actions=${actions}
            .context=${ctx}
  ...
  actions: [
    ...
    },
    {
      ...
      content(ctx) {
        ...
        return html`${keyed(
          model,
          html`<nexio-size-dropdown-menu
            @select=${onSelect}
            @toggle=${onToggle}
            .format=${format}
            .size$=${scale$}
          ></nexio-size-dropdown-menu>`
        )}`;
      },
    },
  ],
...
export const createBuiltinToolbarConfigExtension = (
  ...
  return [
    ...
    ToolbarModuleExtension({
      id: BlockFlavourIdentifier(`nexio:surface:${name}`),
