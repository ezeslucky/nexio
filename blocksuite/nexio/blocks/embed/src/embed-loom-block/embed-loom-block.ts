...
import type { EmbedLoomModel, EmbedLoomStyles } from '@blocksuite/nexio-model';
  ...
  override renderBlock() {
    ...
    return this.renderEmbed(
      () => html`
        ...
        >
          <div class="nexio-embed-loom-video">
            ${videoId
              ? html`
                  <div class="nexio-embed-loom-video-iframe-container">
                    <iframe
                    ...
                    <div
                      class=${classMap({
                        'nexio-embed-loom-video-iframe-overlay': true,
          ...
          <div class="nexio-embed-loom-content">
            <div class="nexio-embed-loom-content-header">
              <div class="nexio-embed-loom-content-title-icon">
                ${titleIcon}
              </div>

              <div class="nexio-embed-loom-content-title-text">
                ${titleText}
              </div>
            </div>

            <div class="nexio-embed-loom-content-description">
              ${descriptionText}
            </div>

            <div class="nexio-embed-loom-content-url" @click=${this.open}>
              <span>loom.com</span>

              <div class="nexio-embed-loom-content-url-icon">${OpenIcon}</div>
            </div>
          </div>
        </div>
      `
