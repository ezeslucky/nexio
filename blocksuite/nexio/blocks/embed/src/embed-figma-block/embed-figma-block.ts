import { OpenIcon } from '@blocksuite/nexio-components/icons';
import type {
  EmbedFigmaModel,
  EmbedFigmaStyles,
        ...
        >
          <div class="nexio-embed-figma">
            <div class="nexio-embed-figma-iframe-container">
              ...
              <div
                class=${classMap({
                  'nexio-embed-figma-iframe-overlay': true,
                  hide: !this.showOverlay$.value,
                })}
              ></div>
            </div>
          </div>
          <div class="nexio-embed-figma-content">
            <div class="nexio-embed-figma-content-header">
              <div class="nexio-embed-figma-content-title-icon">
                ${FigmaIcon}
              </div>

              <div class="nexio-embed-figma-content-title-text">
                ${titleText}
              </div>
            </div>

            ${description
              ? html`<div class="nexio-embed-figma-content-description">
                  ${description}
                </div>`
              : nothing}

            <div class="nexio-embed-figma-content-url" @click=${this.open}>
              <span>www.figma.com</span>

              <div class="nexio-embed-figma-content-url-icon">${OpenIcon}</div>
            </div>
          </div>
        </div>
      `
