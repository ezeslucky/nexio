...
import type { EmbedIframeBlockModel } from '@blocksuite/nexio-model';
import {
  DocModeProvider,
  TelemetryProvider,
...
export class EmbedIframeErrorCard extends WithDisposable(LitElement) {
  static override styles = css`
    ...
    .nexio-embed-iframe-error-card {
      container: nexio-embed-iframe-error-card / size;
      display: flex;
    ...
    .nexio-embed-iframe-error-card.horizontal {
      flex-direction: row;
      ...
      @container nexio-embed-iframe-error-card (width < 480px) {
        .error-banner {
          display: none;
        }
      }
    ...
    .nexio-embed-iframe-error-card.vertical {
      ...
      @container nexio-embed-iframe-error-card (height < 300px) or (width < 300px) {
        .error-banner {
          display: none;
        }
      }
  ...
  override render() {
    ...
    const cardClasses = classMap({
      'nexio-embed-iframe-error-card': true,
