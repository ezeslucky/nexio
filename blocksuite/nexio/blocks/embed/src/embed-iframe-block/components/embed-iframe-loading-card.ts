...
export class EmbedIframeLoadingCard extends LitElement {
  static override styles = css`
    ...
    .nexio-embed-iframe-loading-card {
      container: nexio-embed-iframe-loading-card / size;
      display: flex;
      ...
      @container nexio-embed-iframe-loading-card (width < 360px) {
        .loading-banner {
          display: none;
        }
      }
    ...
    .nexio-embed-iframe-loading-card.horizontal {
      flex-direction: row;
    ...
    .nexio-embed-iframe-loading-card.vertical {
      ...
      @container nexio-embed-iframe-loading-card (height < 240px) {
        .loading-banner {
          display: none;
        }
      }
  ...
  override render() {
    ...
    const cardClasses = classMap({
      'nexio-embed-iframe-loading-card': true,
