  ...
  override renderBlock() {
    ...
    return this.renderEmbed(
      () => html`
        <div
          class=${classMap({
            'nexio-embed-youtube-block': true,
            loading,
        ...
        >
          <div class="nexio-embed-youtube-video">
            ${videoId
              ? html`
                  <div class="nexio-embed-youtube-video-iframe-container">
                    <iframe
                      id="ytplayer"
                      type="text/html"
                    ...
                    <div
                      class=${classMap({
                        'nexio-embed-youtube-video-iframe-overlay': true,
          ...
          <div class="nexio-embed-youtube-content">
            <div class="nexio-embed-youtube-content-header">
              <div class="nexio-embed-youtube-content-title-icon">
                ${titleIcon}
              </div>

              <div class="nexio-embed-youtube-content-title-text">
                ${titleText}
              </div>

              <div class="nexio-embed-youtube-content-creator-image">
                ${creatorImageEl}
              </div>

              <div class="nexio-embed-youtube-content-creator-text">
                ${creator}
              </div>
            </div>
            ...
            ${loading
              ? html`<div
                  class="nexio-embed-youtube-content-description"
                ></div>`
              : descriptionText
                ? html`<div class="nexio-embed-youtube-content-description">
                    ${descriptionText}
                  </div>`
                : nothing}

            <div class="nexio-embed-youtube-content-url" @click=${this.open}>
              <span>www.youtube.com</span>

              <div class="nexio-embed-youtube-content-url-icon">
                ${OpenIcon}
              </div>
            </div>
          </div>
