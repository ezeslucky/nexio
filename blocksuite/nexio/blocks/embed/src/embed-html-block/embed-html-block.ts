import type { EmbedHtmlModel, EmbedHtmlStyles } from '@blocksuite/nexio-model';
  ...
  override renderBlock(): unknown {
    ...
    return this.renderEmbed(() => {
      if (!this.model.props.html) {
        return html` <div class="nexio-html-empty">Empty</div>`;
      }
      return html`
        <div
          class=${classMap({
            'nexio-embed-html-block': true,
        ...
        >
          <div class="nexio-embed-html">
            <div class="nexio-embed-html-iframe-container">
              ...
              <div
                class=${classMap({
                  'nexio-embed-html-iframe-overlay': true,
          ...
          <div class="nexio-embed-html-title">
            <div class="nexio-embed-html-title-icon">${HtmlIcon}</div>

            <div class="nexio-embed-html-title-text">${titleText}</div>
          </div>
        </div>
      `;
    });
