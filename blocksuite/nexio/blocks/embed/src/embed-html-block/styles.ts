...
export const styles = css`
  ...
  .nexio-embed-html img,
  .nexio-embed-html object,
  .nexio-embed-html svg {
    width: 100%;
    height: 100%;
    object-fit: cover;
    border-radius: 4px;
  ...
  .nexio-embed-html-iframe-container {
    position: relative;
    width: 100%;
    height: 100%;
  ...
  .embed-html-block-iframe-wrapper nexio-menu {
    min-width: 296px;
  }

  .embed-html-block-iframe-wrapper nexio-menu .settings-header {
    padding: 7px 12px;
    font-weight: 500;
  ...
  .nexio-embed-html-iframe-overlay {
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
  ...
  .nexio-embed-html-iframe-overlay.hide {
    display: none;
  }

  .nexio-embed-html-title {
    height: fit-content;
    display: flex;
    align-items: center;
    gap: 8px;
  ...
  .nexio-embed-html-title-icon img,
  .nexio-embed-html-title-icon object,
  .nexio-embed-html-title-icon svg {
    width: 20px;
    height: 20px;
    fill: var(--nexio-background-primary-color);
  }

  .nexio-embed-html-title-text {
    display: -webkit-box;
    -webkit-line-clamp: 1;
