import { getSurfaceBlock } from '@blocksuite/nexio-block-surface';
import {
  type DocMode,
  ListBlockModel,
  NoteBlockModel,
...
export function createLinkedDocFromSlice(
  ...
  linkedDoc.load(() => {
    ...
    const noteId = linkedDoc.addBlock('nexio:note', {}, rootId);
