...
export const styles = css`
  .nexio-embed-github-block {
    container: nexio-embed-github-block / inline-size;
  ...
  .nexio-embed-github-content-title {
    display: flex;
    min-height: 22px;
    flex-direction: row;
    gap: 8px;
  ...
  .nexio-embed-github-content-title-icons {
    display: flex;
  ...
  .nexio-embed-github-content-title-icons img,
  .nexio-embed-github-content-title-icons object,
  .nexio-embed-github-content-title-icons svg {
    width: 16px;
    height: 16px;
    color: var(--nexio-pure-white);
  }

  .nexio-embed-github-content-title-site-icon {
    display: flex;
    width: 16px;
    height: 16px;
    justify-content: center;
    ...
    .github-icon {
      fill: var(--nexio-black);
      color: var(--nexio-black);
    }
  }

  .nexio-embed-github-content-title-status-icon {
    display: flex;
    align-items: center;
    gap: 4px;
    padding: 3px 6px;
  ...
  .nexio-embed-github-content-title-status-icon.issue.open {
    background: #238636;
  }
  .nexio-embed-github-content-title-status-icon.issue.closed.success {
    background: #8957e5;
  }
  .nexio-embed-github-content-title-status-icon.issue.closed.failure {
    background: #6e7681;
  }
  .nexio-embed-github-content-title-status-icon.pr.open {
    background: #238636;
  }
  .nexio-embed-github-content-title-status-icon.pr.draft {
    background: #6e7681;
  }
  .nexio-embed-github-content-title-status-icon.pr.merged {
    background: #8957e5;
  }
  .nexio-embed-github-content-title-status-icon.pr.closed {
    background: #c03737;
  }

  .nexio-embed-github-content-title-status-icon > svg {
    height: 16px;
    width: 16px;
    padding: 2px;
  }

  .nexio-embed-github-content-title-status-icon > span {
    padding: 0px 1.5px;
  }

  .nexio-embed-github-content-title-text {
    display: -webkit-box;
    -webkit-line-clamp: 1;
  ...
  .nexio-embed-github-content-description {
    display: -webkit-box;
    -webkit-line-clamp: 2;
    -webkit-box-orient: vertical;
  ...
  .nexio-embed-github-content-assignees {
    display: none;
  }

  .nexio-embed-github-content-url {
    display: flex;
    align-items: center;
  ...
  .nexio-embed-github-content-url > span {
    display: -webkit-box;
    -webkit-line-clamp: 1;
    -webkit-box-orient: vertical;
  ...
  .nexio-embed-github-content-url:hover > span {
    color: var(--nexio-link-color);
  }
  .nexio-embed-github-content-url:hover .open-icon {
    fill: var(--nexio-link-color);
  }

  .nexio-embed-github-content-url-icon {
    display: flex;
    align-items: center;
    justify-content: center;
    width: 12px;
  ...
  .nexio-embed-github-content-url-icon .open-icon {
    height: 12px;
    width: 12px;
    fill: var(--nexio-text-secondary-color);
  }

  .nexio-embed-github-banner {
    margin: 12px 0px 0px 12px;
    width: 204px;
    height: 102px;
  }

  .nexio-embed-github-banner img,
  .nexio-embed-github-banner object,
  .nexio-embed-github-banner svg {
    width: 204px;
    height: 102px;
    object-fit: cover;
    border-radius: 4px;
  ...
  .nexio-embed-github-block.loading {
    .nexio-embed-github-content-title-text {
      color: var(--nexio-placeholder-color);
    }
  }

  .nexio-embed-github-block.selected {
    .nexio-embed-github-content-url > span {
      color: var(--nexio-link-color);
    }
    .nexio-embed-github-content-url .open-icon {
      fill: var(--nexio-link-color);
    }
  }

  .nexio-embed-github-block.list {
    .nexio-embed-github-content {
      width: 100%;
      flex-direction: row;
      align-items: center;
    ...
    .nexio-embed-github-content-repo {
      display: none;
    }

    .nexio-embed-github-content-date {
      display: none;
    }
  ...
  .nexio-embed-github-block.vertical {
    ...
    .nexio-embed-github-content-assignees-text {
      display: -webkit-box;
      -webkit-line-clamp: 1;
      -webkit-box-orient: vertical;
    ...
    .nexio-embed-github-content-assignees-text.label {
      width: 72px;
      color: var(--nexio-text-primary-color);
      font-weight: 600;
    }

    .nexio-embed-github-content-assignees-text.users {
      width: calc(100% - 72px);
      word-break: break-all;
      white-space: normal;
      overflow: hidden;
    ...
    .nexio-embed-github-content-assignees-text-users.user {
      color: var(--nexio-link-color);
      cursor: pointer;
    }

    .nexio-embed-github-content-assignees-text-users.placeholder {
      color: var(--nexio-placeholder-color);
    }
  ...
  @container nexio-embed-github-block (width < 375px) {
    .nexio-embed-github-content {
      width: 100%;
    }

    .nexio-embed-github-block:not(.edgeless) .nexio-embed-github-banner {
      display: none;
    }
  }
`;
