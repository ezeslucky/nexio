import { toEdgelessEmbedBlock } from '@blocksuite/nexio-block-embed';
import {
  EdgelessCRUDIdentifier,
  reassociateConnectorsCommand,
} from '@blocksuite/nexio-block-surface';
import { type AliasInfo } from '@blocksuite/nexio-model';
import {
  EMBED_CARD_HEIGHT,
  EMBED_CARD_WIDTH,
...
export class EmbedEdgelessSyncedDocBlockComponent extends toEdgelessEmbedBlock(
  ...
  @query('.nexio-embed-synced-doc-edgeless-header-wrapper')
  accessor headerWrapper: HTMLDivElement | null = null;

  @query('nexio-preview-root')
    ...
    return this.renderEmbed(
      () => html`
        <div
          ...
          ?data-scale=${scale}
        >
          <div class="nexio-embed-synced-doc-edgeless-header-wrapper">
            ${header}
          </div>
          ...
          <div class="nexio-embed-synced-doc-editor-overlay"></div>
        </div>
      `
    );
  };
