import { RENDER_CARD_THROTTLE_MS } from '@blocksuite/nexio-block-embed';
...
export class EmbedSyncedDocCard extends WithDisposable(ShadowlessElement) {
  ...
  override render() {
    ...
    return html`
      <div
        class="nexio-embed-synced-doc-card ${cardClassMap}"
        @click=${this._handleClick}
      >
        <div class="nexio-embed-synced-doc-card-content">
          <div class="nexio-embed-synced-doc-card-content-title">
            <div class="nexio-embed-synced-doc-card-content-title-icon">
              ${icon}
            </div>

            <div class="nexio-embed-synced-doc-card-content-title-text">
              ${title}
            </div>
          </div>

          ${showDefaultNoteContent
            ? html`<div class="nexio-embed-synced-doc-content-note default">
                ${defaultNoteContent}
              </div>`
            : nothing}
          <div class="nexio-embed-synced-doc-content-note render"></div>

          ${error
            ? html`
                <div class="nexio-embed-synced-doc-card-content-reload">
                  <div
                    class="nexio-embed-synced-doc-card-content-reload-button"
              ...
              `
            : html`
                <div class="nexio-embed-synced-doc-card-content-date">
                  <span>Updated</span>
        ...
        <div class="nexio-embed-synced-doc-card-banner render"></div>

        ${showDefaultBanner
          ? html`
              <div class="nexio-embed-synced-doc-card-banner default">
                ${defaultBanner}
              </div>
            `
          : nothing}
  ...
  @queryAsync('.nexio-embed-synced-doc-card-banner.render')
  ...
  @queryAsync('.nexio-embed-synced-doc-content-note.render')
