...
import { getBlockProps, matchModels } from '@blocksuite/nexio-shared/utils';
    ...
    conversionsActionGroup,
    {
      ...
      run: ctx => {
        ...
        ctx.track('BlockCreated', {
          ...
          module: 'toolbar',
          segment: 'toolbar',
          blockType: 'nexio:embed-linked-doc',
          ...
          .pipe(({ std, draftedModels }, next) => {
            (async () => {
              ...
              std.store.addBlock(
                'nexio:paragraph',
                {
                  text: new Text<NexioTextAttributes>([
                    {
