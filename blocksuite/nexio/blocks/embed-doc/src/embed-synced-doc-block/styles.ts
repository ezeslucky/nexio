import { embedNoteContentStyles } from '@blocksuite/nexio-block-embed';
import {
  EMBED_CARD_HEIGHT,
  EMBED_CARD_WIDTH,
...
export const blockStyles = css`
  ...
  nexio-embed-synced-doc-block[data-page-mode] {
  ...
  .edgeless-block-portal-embed
    > nexio-embed-synced-doc-block[data-nested-editor] {
    position: relative;
    display: block;
    left: 0px;
    top: 0px;
  ...
  .edgeless-block-portal-embed
    .nexio-embed-synced-doc-editor
    .nexio-page-root-block-container {
    width: 100%;
  }

  .edgeless-block-portal-embed .nexio-embed-synced-doc-container.edgeless {
    display: block;
    padding: 0;
    width: 100%;
    height: calc(${EMBED_CARD_HEIGHT.syncedDoc}px + 36px);
  }
  .edgeless-block-portal-embed .nexio-embed-synced-doc-container.surface {
    border: 1px solid var(--nexio-border-color);
  }

  nexio-embed-synced-doc-block[data-nested-editor],
  nexio-embed-edgeless-synced-doc-block[data-nested-editor] {
    .nexio-embed-synced-doc-container.page {
  ...
  .nexio-embed-synced-doc-container {
    border: 1px solid transparent;
    border-radius: 8px;
    overflow: hidden;
  }
  .nexio-embed-synced-doc-container.comment-highlighted {
    outline: 2px solid ${unsafeCSSVarV2('block/comment/highlightUnderline')};
  }
  .nexio-embed-synced-doc-container.show-hover-border:hover {
  ...
  .nexio-embed-synced-doc-container.edgeless {
    display: block;
    width: 100%;
    height: calc(${EMBED_CARD_HEIGHT.syncedDoc}px + 36px);
  }
  .nexio-embed-synced-doc-header-wrapper {
    position: absolute;
    top: 0;
    left: 0;
    height: 34px;
  ...
  .nexio-embed-synced-doc-header-wrapper.selected {
    opacity: 1;
    transition: all 0.23s ease;
  }
  .nexio-embed-synced-doc-header {
    display: flex;
    align-items: center;
    width: 100%;
    height: 100%;
  ...
  .nexio-embed-synced-doc-header svg {
    flex-shrink: 0;
  }
  .nexio-embed-synced-doc-icon {
    line-height: 0;
    color: ${unsafeCSSVarV2('icon/primary')};
  }
  .nexio-embed-synced-doc-title {
    font-size: 14px;
    font-weight: 600;
    line-height: 22px;
    margin-left: 8px;
  ...
  .nexio-embed-synced-doc-editor-overlay {
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
  ...
  .nexio-embed-synced-doc-editor-empty {
    display: flex;
    align-items: center;
    width: 100%;
    height: 100%;
  ...
  .nexio-embed-synced-doc-container.surface
    > .nexio-embed-synced-doc-editor
    > .nexio-embed-synced-doc-editor-empty {
    left: 0;
  ...
  .nexio-embed-synced-doc-editor-empty > span {
  ...
  .nexio-embed-synced-doc-container
    > .nexio-embed-synced-doc-editor.nexio-page-viewport {
    background: transparent;
  }

  .nexio-embed-synced-doc-container > .nexio-embed-synced-doc-editor {
    width: 100%;
    height: 100%;
  }

  .nexio-embed-synced-doc-editor .nexio-page-root-block-container {
    width: 100%;
    max-width: 100%;
  }
...
export const cardStyles = css`
  ...
  .nexio-embed-synced-doc-card-content {
  ...
  .nexio-embed-synced-doc-card-content-title {
    display: flex;
    flex-direction: row;
    gap: 8px;
    align-items: center;
  ...
  .nexio-embed-synced-doc-card-content-title-icon {
    display: flex;
    width: 16px;
    height: 16px;
    justify-content: center;
  ...
  .nexio-embed-synced-doc-card-content-title-icon svg {
    width: 16px;
    height: 16px;
    fill: var(--nexio-background-primary-color);
  }

  .nexio-embed-synced-doc-card-content-title-text {
    display: -webkit-box;
    -webkit-line-clamp: 1;
  ...
  .nexio-embed-synced-doc-content-note.render {
    display: none;
    overflow: hidden;
    pointer-events: none;
  }
  ...
  .nexio-embed-synced-doc-content-note.default {
    display: -webkit-box;
    -webkit-line-clamp: 2;
    -webkit-box-orient: vertical;
    white-space: normal;
  ...
  .nexio-embed-synced-doc-card-content-date,
  .nexio-embed-synced-doc-card-content-reload {
    display: flex;
    flex-grow: 1;
  ...
  .nexio-embed-synced-doc-card-content-date > span {
    display: -webkit-box;
    -webkit-line-clamp: 1;
    -webkit-box-orient: vertical;
  ...
  .nexio-embed-synced-doc-card-content-reload-button {
    display: flex;
    flex-direction: row;
    align-items: center;
    gap: 4px;
  ...
  .nexio-embed-synced-doc-card-content-reload-button svg {
    width: 12px;
    height: 12px;
  }
  .nexio-embed-synced-doc-card-content-reload-button > span {
    display: -webkit-box;
    -webkit-line-clamp: 1;
    -webkit-box-orient: vertical;
    word-break: break-all;
  ...
  .nexio-embed-synced-doc-card-banner {
  ...
  .nexio-embed-synced-doc-card-banner.render {
    display: none;
  }
  .nexio-embed-synced-doc-card-banner img,
  .nexio-embed-synced-doc-card-banner object,
  .nexio-embed-synced-doc-card-banner svg {
    width: 204px;
    max-width: 100%;
    height: 102px;
    object-fit: cover;
  ...
  .nexio-embed-synced-doc-card.loading,
  .nexio-embed-synced-doc-card.deleted,
  .nexio-embed-synced-doc-card.error {
    .nexio-embed-linked-doc-content-note.render {
      display: none;
    }
    .nexio-embed-linked-doc-content-note.default {
      display: block;
    }
    .nexio-embed-synced-doc-card-banner.render {
      display: none;
    }
    .nexio-embed-synced-doc-card-banner.default {
      display: block;
    }
    .nexio-embed-synced-doc-card-content-date {
      display: none;
  ...
  .nexio-embed-synced-doc-card:not(.loading).deleted,
  .nexio-embed-synced-doc-card:not(.loading).error {
    background: var(--nexio-background-secondary-color);
  }
  .nexio-embed-synced-doc-card:not(.loading):not(.error):not(
      .surface
    ).deleted {
  ...
  .nexio-embed-synced-doc-card:not(.loading):not(.error):not(.deleted):not(
      .note-empty
    ).cycle {
    .nexio-embed-synced-doc-content-note.render {
      display: block;
  ...
  .nexio-embed-synced-doc-card.surface:not(.cycle) {
    ...
    .nexio-embed-synced-doc-card-content-note {
      margin: 0 auto;
      flex-grow: 0;
    }
  ...
  .nexio-embed-synced-doc-card.surface:not(.loading):not(.error):not(
      .deleted
    ).cycle {
  ...
  .nexio-embed-synced-doc-edgeless-header-wrapper {
    position: relative;
