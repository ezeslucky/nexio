...
import { SurfaceBlockModel } from '@blocksuite/nexio-block-surface';
import { LoadingIcon } from '@blocksuite/nexio-components/icons';
import { isPeekable, Peekable } from '@blocksuite/nexio-components/peek';
import { RefNodeSlotsProvider } from '@blocksuite/nexio-inline-reference';
import type {
  DocMode,
  EmbedLinkedDocModel,
...
export class EmbedLinkedDocBlockComponent extends EmbedBlockComponent<EmbedLinkedDocModel> {
  ...
  private readonly _renderEmbedView = () => {
    ...
    return this.renderEmbed(
      () => html`
        <div
          class="nexio-embed-linked-doc-block ${cardClassMap}"
          @click=${this._handleClick}
          @dblclick=${this._handleDoubleClick}
        >
          <div class="nexio-embed-linked-doc-content">
            <div class="nexio-embed-linked-doc-content-title">
              <div class="nexio-embed-linked-doc-content-title-icon">
                ${icon}
              </div>

              <div class="nexio-embed-linked-doc-content-title-text">
                ${title}
              </div>
            </div>
            ...
            ${when(
              hasDescriptionAlias,
              () =>
                html`<div class="nexio-embed-linked-doc-content-note alias">
                  ${repeat(
              ...
              () =>
                when(
                  ...
                  () => html`
                    <div class="nexio-embed-linked-doc-content-note default">
                      ${defaultNoteContent}
                    </div>
                  `,
                  () => html`
                    <div
                      class="nexio-embed-linked-doc-content-note render"
                    ></div>
                  `
                )
            )}
            ${isError
              ? html`
                  <div class="nexio-embed-linked-doc-card-content-reload">
                    <div
                      class="nexio-embed-linked-doc-card-content-reload-button"
                ...
                `
              : html`
                  <div class="nexio-embed-linked-doc-content-date">
                    <span>Updated</span>
          ...
          ${showDefaultBanner
            ? html`
                <div class="nexio-embed-linked-doc-banner default">
                  ${defaultBanner}
                </div>
              `
            : nothing}
  ...
  @queryAsync('.nexio-embed-linked-doc-content-note.render')
