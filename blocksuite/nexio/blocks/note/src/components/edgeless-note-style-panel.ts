...
import type { SliderSelectEvent } from '@blocksuite/nexio-components/slider';
import {
  DefaultTheme,
  NoteBlockModel,
  type NoteProps,
  ...
  private _renderStylePanel() {
    return html`<div class="edgeless-note-style-panel">
      ...
      <div
        ...
        data-testid="nexio-note-border-style-panel"
      >
      ...
      <div
        class="edgeless-note-style-section"
        data-testid="nexio-note-corner-radius-panel"
      >
