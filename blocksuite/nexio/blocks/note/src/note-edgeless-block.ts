...
import type { DocTitle } from '@blocksuite/nexio-fragment-doc-title';
import { NoteBlockSchema, NoteDisplayMode } from '@blocksuite/nexio-model';
import { focusTextModel } from '@blocksuite/nexio-rich-text';
import { EDGELESS_BLOCK_CHILD_PADDING } from '@blocksuite/nexio-shared/consts';
...
export const NEXIO_EDGELESS_NOTE = 'nexio-edgeless-note';
...
declare global {
  interface HTMLElementTagNameMap {
    [NEXIO_EDGELESS_NOTE]: EdgelessNoteBlockComponent;
  }
}
