import { ListBlockSchema } from '@blocksuite/nexio-model';
import {
  AdapterTextUtils,
...
export const listBlockHtmlAdapterMatcher: BlockHtmlAdapterMatcher = {
  ...
  fromBlockSnapshot: {
    enter: (o, context) => {
      ...
      if (
        walkerContext.getNodeContext('nexio:list:parent') === o.parent &&
        ...
        walkerContext.setNodeContext('nexio:list:parent', o.parent);
      }
      ...
      walkerContext.openNode(
        {
          ...
          tagName: 'li',
          properties: {
            className: ['nexio-list-block-container'],
          },
          children: liChildren,
        },
        'children'
    ...
    leave: (o, context) => {
      ...
      if (
        walkerContext.getPreviousNodeContext('nexio:list:parent') ===
          o.parent &&
