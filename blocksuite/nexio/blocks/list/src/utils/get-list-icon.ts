  ...
  switch (model.props.type) {
    case 'bulleted':
      return html`<div
        ...
        class="nexio-list-block__prefix"
        @click=${onClick}
      >
    ...
    case 'numbered':
      return html`<div
        contenteditable="false"
        class="nexio-list-block__prefix nexio-list-block__numbered"
        @click=${onClick}
      >
    ...
    case 'todo':
      return html`<div
        contenteditable="false"
        class=${`nexio-list-block__prefix nexio-list-block__todo-prefix ${model.store.readonly ? 'readonly' : ''}`}
        @click=${onClick}
      >
        ${model.props.checked
