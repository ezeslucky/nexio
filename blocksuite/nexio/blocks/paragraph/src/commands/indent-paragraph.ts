import { ListBlockModel, ParagraphBlockModel } from '@blocksuite/nexio-model';
import type { IndentContext } from '@blocksuite/nexio-shared/types';
import {
...
export const indentParagraphCommand: Command<{
  ...
  if (
    ...
    indentContext.flavour !== 'nexio:paragraph'
  ) {
    console.warn(
  ...
  // update collapsed state of nexio list
  if (
