...
export class ParagraphBlockComponent extends CaptionedBlockComponent<ParagraphBlockModel> {
  ...
  private readonly _isInDatabase = () => {
    ...
    while (parent && parent !== document.body) {
      if (parent.tagName.toLowerCase() === 'nexio-database') {
        return true;
      }
  ...
  override renderBlock(): TemplateResult<1> {
    ...
    return html`
      ${style}
      <style>
        .nexio-paragraph-block-container[data-has-collapsed-siblings='false']
          nexio-paragraph-heading-icon
          .heading-icon {
      ...
      <div
        class=${classMap({
          'nexio-paragraph-block-container': true,
      ...
      >
        <div
          class=${classMap({
            'nexio-paragraph-rich-text-wrapper': true,
            [type$.value]: true,
          ...
          ${this.inEdgelessText
            ...
            : html`
                <div
                  ...
                  class=${classMap({
                    'nexio-paragraph-placeholder': true,
  ...
  override accessor blockContainerStyles = {
    margin: 'var(--nexio-paragraph-margin, 10px 0)',
  };
}
