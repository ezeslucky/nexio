import { ConfirmIcon } from '@blocksuite/nexio-components/icons';
import { toast } from '@blocksuite/nexio-components/toast';
import type { AttachmentBlockModel } from '@blocksuite/nexio-model';
import { CitationProvider } from '@blocksuite/nexio-shared/services';
...
export const RenameModal = ({
  ...
  return html`
    ...
    <div class="nexio-attachment-rename-overlay-mask" @click="${abort}"></div>
    <div class="nexio-attachment-rename-container">
      <div class="nexio-attachment-rename-input-wrapper">
        <input
          ${ref(inputRef)}
          type="text"
          .value=${fileName}
          ...
          @keydown=${onKeydown}
        />
        <span class="nexio-attachment-rename-extension">${extension}</span>
      </div>
      <editor-icon-button
