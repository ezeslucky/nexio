...
import type { TableBlockModel } from '@blocksuite/nexio-model';
...
import { VirtualPaddingController } from '@blocksuite/nexio-shared/utils';
...
export const TableBlockComponentName = 'nexio-table';
        ...
        >
          <table class=${tableWrapper} ${ref(this.table$)}>
            ...
            ${IS_MOBILE || this.dataManager.readonly$.value
              ? nothing
              : html`<nexio-table-add-button
                  style="display: contents;"
                  .dataManager=${this.dataManager}
                ></nexio-table-add-button>`}
            ${html`<nexio-table-selection-layer
              style="display: contents;"
              .selectionController=${this.selectionController}
              .getRowRect=${this.getRowRect}
              .getColumnRect=${this.getColumnRect}
              .getAreaRect=${this.getAreaRect}
            ></nexio-table-selection-layer>`}
          </table>
        </div>
      </div>
    `;
