...
import { TextBackgroundDuotoneIcon } from '@blocksuite/nexio-components/icons';
import { DefaultInlineManagerExtension } from '@blocksuite/nexio-inline-preset';
import type { TableColumn, TableRow } from '@blocksuite/nexio-model';
import { RichText } from '@blocksuite/nexio-rich-text';
import { cssVarV2 } from '@blocksuite/nexio-shared/theme';
...
export const TableCellComponentName = 'nexio-table-cell';
export class TableCell extends SignalWatcher(
  ...
  get inlineManager() {
    return this.closest<TableBlockComponent>('nexio-table')?.std.get(
      DefaultInlineManagerExtension.identifier
    );
  }

  get topContenteditableElement() {
    return this.closest<TableBlockComponent>('nexio-table')
        ...
        <rich-text
          ...
          .verticalScrollContainerGetter="${() =>
            this.topContenteditableElement?.host
              ...
              : null}"
          data-parent-flavour="nexio:table"
        ></rich-text>
