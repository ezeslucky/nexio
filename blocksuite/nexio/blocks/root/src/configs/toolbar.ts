...
} from '@blocksuite/nexio-block-database';
import {
...
import type { HighlightType } from '@blocksuite/nexio-components/highlight-dropdown-menu';
import { toast } from '@blocksuite/nexio-components/toast';
import { EditorChevronDown } from '@blocksuite/nexio-components/toolbar';
import {
  deleteTextCommand,
  formatBlockCommand,
  formatNativeCommand,
