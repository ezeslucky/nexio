...
import { EdgelessTextBlockComponent } from '@blocksuite/nexio-block-edgeless-text';
import {
  FrameTool,
  type PresentToolOption,
} from '@blocksuite/nexio-block-frame';
import {
  DefaultTool,
...
import {
  ...
  EraserTool,
  HighlighterTool,
} from '@blocksuite/nexio-gfx-brush';
import {
  ConnectorTool,
  mountConnectorLabelEditor,
} from '@blocksuite/nexio-gfx-connector';
import {
  createGroupFromSelectedCommand,
  ungroupCommand,
} from '@blocksuite/nexio-gfx-group';
import {
  getNearestTranslation,
  isElementOutsideViewport,
  isSingleMindMapNode,
} from '@blocksuite/nexio-gfx-mindmap';
import { NoteTool } from '@blocksuite/nexio-gfx-note';
import { PanTool } from '@blocksuite/nexio-gfx-pointer';
import { mountShapeTextEditor, ShapeTool } from '@blocksuite/nexio-gfx-shape';
import { TextTool } from '@blocksuite/nexio-gfx-text';
import {
