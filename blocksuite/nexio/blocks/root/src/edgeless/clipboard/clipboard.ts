import { addAttachments } from '@blocksuite/nexio-block-attachment';
import { EdgelessFrameManagerIdentifier } from '@blocksuite/nexio-block-frame';
import { addImages } from '@blocksuite/nexio-block-image';
import {
  CanvasRenderer,
  DefaultTool,
...
import { splitIntoLines } from '@blocksuite/nexio-gfx-text';
import type {
  EmbedCardStyle,
  ShapeElementModel,
