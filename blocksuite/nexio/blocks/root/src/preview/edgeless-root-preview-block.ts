...
import { requestThrottledConnectedFrame } from '@blocksuite/nexio-shared/utils';
import {
  BlockComponent,
...
export class EdgelessRootPreviewBlockComponent extends BlockComponent<RootBlockModel> {
  static override styles = css`
    ...
    nexio-edgeless-root-preview .widgets-container {
      position: absolute;
      left: 0;
      top: 0;
      contain: size layout;
    ...
    nexio-edgeless-root-preview .edgeless-background {
      height: 100%;
