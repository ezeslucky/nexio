import type { EditorIconButton } from '@blocksuite/nexio-components/toolbar';
...
export class LinkPopup extends WithDisposable(ShadowlessElement) {
  ...
  private readonly _createTemplate = () => {
    ...
    return html`
      <div class="nexio-link-popover create">
        <input
          id="link-input"
          class="nexio-link-popover-input"
          type="text"
          spellcheck="false"
  ...
  private readonly _editTemplate = () => {
    ...
    return html`
      <div class="nexio-link-edit-popover">
        <div class="nexio-edit-area text">
          <input
            class="nexio-edit-input"
            id="text-input"
            type="text"
            placeholder="Enter text"
            @input=${this._updateConfirmBtn}
          />
          <label class="nexio-edit-label" for="text-input">Text</label>
        </div>
        <div class="nexio-edit-area link">
          <input
            id="link-input"
            class="nexio-edit-input"
            type="text"
            ...
            @input=${this._updateConfirmBtn}
          />
          <label class="nexio-edit-label" for="link-input">Link</label>
        </div>
        ${this._confirmBtnTemplate()}
      </div>
    `;
  ...
  @query('.nexio-confirm-button')
  accessor confirmButton: EditorIconButton | null = null;

  @property({ attribute: false })
  accessor inlineEditor!: NexioInlineEditor;
