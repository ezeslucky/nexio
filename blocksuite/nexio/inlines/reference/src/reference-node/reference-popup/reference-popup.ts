...
import { fontXSStyle, panelBaseStyle } from '@blocksuite/nexio-shared/styles';
...
export class ReferencePopup extends SignalWatcher(
  ...
  private _setTitle(title?: string) {
    const reference: NexioTextAttributes['reference'] = {
      type: 'LinkedPage',
      ...this.referenceInfo,
    };
  ...
  @property({ attribute: false })
  accessor inlineEditor!: InlineEditor<NexioTextAttributes>;
