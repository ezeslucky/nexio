import { insertLinkedNode } from '@blocksuite/nexio-inline-reference';
import { CodeBlockModel } from '@blocksuite/nexio-model';
import { getInlineEditorByModel } from '@blocksuite/nexio-rich-text';
import { BRACKET_PAIRS } from '@blocksuite/nexio-shared/consts';
import { createDefaultDoc, matchModels } from '@blocksuite/nexio-shared/utils';
import {
  type BlockStdScope,
  TextSelection,
  type UIEventHandler,
