import { DefaultTool } from '@blocksuite/nexio-block-surface';
import {
  darkToolbarStyles,
  lightToolbarStyles,
...
import { EdgelessDraggableElementController } from '@blocksuite/nexio-widget-edgeless-toolbar';
...
export class EdgelessTemplatePanel extends WithDisposable(LitElement) {
  static override styles = css`
    ...
    .search-bar {
      padding: 21px 24px;
      font-size: 18px;
      color: var(--nexio-secondary);
      border-bottom: 1px solid var(--nexio-divider-color);
    ...
    .category-entry:hover {
      color: var(--nexio-text-primary-color);
      background-color: var(--nexio-background-tertiary-color);
    }
    ...
    .template-item > svg {
      ...
      width: 135px;
      height: 80px;
      color: var(--nexio-background-primary-color);
    }
    ...
    /* .template-item:hover::before {
      ...
      background-color: var(--nexio-primary-color);
    ...
    .template-item.loading > nexio-template-loading {
      position: absolute;
      left: 50%;
      top: 50%;
      transform: translate(-50%, -50%);
    ...
    .arrow {
      ...
      color: var(--nexio-background-overlay-panel-color);
    }
  `;
        ...
        <div class="template-viewport">
          <div class="template-scrollcontent" data-scrollable>
            <div class="template-list">
              ${this._loading
                ? html`<nexio-template-loading
                    style=${styleMap({
                      position: 'absolute',
                      left: '50%',
                      top: '50%',
                    })}
                  ></nexio-template-loading>`
                : repeat(
                    _templates,
                      ...
                      return html`
                        ...
                        >
                          ...
                          ${template === this._loadingTemplate
                            ? html`<nexio-template-loading></nexio-template-loading>`
                            : nothing}
                          ${template.name
                            ? html`<nexio-tooltip
                                .offset=${12}
