...
import {
  packColor,
  type PickColorEvent,
} from '@blocksuite/nexio-components/color-picker';
import type { LineDetailType } from '@blocksuite/nexio-components/edgeless-line-styles-panel';
import { createTextActions } from '@blocksuite/nexio-gfx-text';
import {
  type Color,
  DefaultTheme,
  FontFamily,
...
import { getMostCommonValue } from '@blocksuite/nexio-shared/utils';
import {
  getRootBlock,
  LINE_STYLE_LIST,
  renderMenu,
} from '@blocksuite/nexio-widget-edgeless-toolbar';
...
export const shapeToolbarExtension = ToolbarModuleExtension({
  id: BlockFlavourIdentifier('nexio:surface:shape'),
