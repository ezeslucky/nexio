...
import { DefaultTheme, TextElementModel } from '@blocksuite/nexio-model';
import type { RichText } from '@blocksuite/nexio-rich-text';
import { ThemeProvider } from '@blocksuite/nexio-shared/services';
import { getSelectedRect } from '@blocksuite/nexio-shared/utils';
  ...
  static override styles = css`
    .edgeless-text-editor {
      ...
      border: ${EdgelessTextEditor.BORDER_WIDTH}px solid
        var(--nexio-primary-color, #1e96eb);
      border-radius: 4px;
