...
import { getLineHeight } from '@blocksuite/nexio-gfx-text';
...
import { almostEqual } from '@blocksuite/nexio-shared/utils';
...
export class EdgelessConnectorLabelEditor extends WithDisposable(
  ...
  static override styles = css`
    .edgeless-connector-label-editor {
      ...
      border: ${BORDER_WIDTH}px solid var(--nexio-primary-color, #1e96eb);
      background: var(--nexio-background-primary-color, #fff);
      border-radius: 2px;
