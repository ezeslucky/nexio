...
import { MAX_IMAGE_WIDTH } from '@blocksuite/nexio-model';
import { TelemetryProvider } from '@blocksuite/nexio-shared/services';
import type { NoteChildrenFlavour } from '@blocksuite/nexio-shared/types';
import {
  getImageFilesFromLocal,
  openSingleFileWith,
} from '@blocksuite/nexio-shared/utils';
import { EdgelessToolbarToolMixin } from '@blocksuite/nexio-widget-edgeless-toolbar';
...
export class EdgelessNoteMenu extends EdgelessToolbarToolMixin(LitElement) {
  static override styles = css`
    ...
    .divider {
      width: 1px;
      height: 24px;
      background: var(--nexio-border-color);
