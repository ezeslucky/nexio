...
export class EdgelessNoteSeniorButton extends EdgelessToolbarToolMixin(
  ...
  static override styles = css`
    ...
    .note-root[data-app-theme='light'] {
      --paper-border-color: var(--nexio-pure-white);
    ...
    .note-root[data-app-theme='dark'] {
      --paper-border-color: var(--nexio-divider-color);
    ...
    .edgeless-toolbar-note-icon {
      ...
      align-items: center;
      justify-content: center;
      color: var(--nexio-icon-secondary);
  ...
  override render() {
    ...
    return html`<edgeless-toolbar-button
      ...
      .tooltip=${this.popper
        ? ''
        : html`<nexio-tooltip-content-with-shortcut
            data-tip="${'Note'}"
            data-shortcut="${'N'}"
  ...
  @state()
  accessor childFlavour: NoteToolOption['childFlavour'] = 'nexio:paragraph';
