...
import { ColorScheme, type RootBlockModel } from '@blocksuite/nexio-model';
import {
  EditPropsStore,
  ThemeProvider,
...
export class EdgelessToolbarWidget extends WidgetComponent<RootBlockModel> {
  static override styles = css`
    ...
    .full-divider::after {
      ...
      width: 1px;
      height: 100%;
      background-color: var(--nexio-border-color);
    }
    .pen-and-eraser {
      display: flex;
      height: 100%;
    ...
    return html`
      ...
      <div class="quick-tool-more">
        ...
        >
          ...
          <nexio-tooltip tip-position="top" .offset=${25}>
            More Tools
          </nexio-tooltip>
        </icon-button>
      </div>
        ...
        >
          ...
          ${cache(
            this._seniorPrevTooltip
              ? html` <nexio-tooltip tip-position="top" .offset=${4}>
                  ${this._seniorPrevTooltip}
                </nexio-tooltip>`
              : nothing
          )}
      ...
      >
        ...
        >
          <smooth-corner
            ...
            .smooth=${0.7}
            .borderWidth=${1}
            .bgColor=${'var(--nexio-background-overlay-panel-color)'}
            .borderColor=${'var(--nexio-border-color)'}
