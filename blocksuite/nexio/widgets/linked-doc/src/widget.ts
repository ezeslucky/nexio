...
export class NexioLinkedDocWidget extends WidgetComponent<RootBlockModel> {
  ...
  private readonly _renderLinkedDocMenu = () => {
    ...
    return html`<nexio-mobile-linked-doc-menu
  ...
  private readonly _renderLinkedDocPopover = () => {
    return html`<nexio-linked-doc-popover
      .context=${this._context}
    ></nexio-linked-doc-popover>`;
  };
...
export const linkedDocWidget = WidgetViewExtension(
  'nexio:page',
  NEXIO_LINKED_DOC_WIDGET,
  literal`${unsafeStatic(NEXIO_LINKED_DOC_WIDGET)}`
);

declare global {
  interface HTMLElementTagNameMap {
    [NEXIO_LINKED_DOC_WIDGET]: NexioLinkedDocWidget;
  }
}
