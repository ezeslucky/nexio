...
export const NEXIO_EDGELESS_ZOOM_TOOLBAR_WIDGET =
  'nexio-edgeless-zoom-toolbar-widget';

export class NexioEdgelessZoomToolbarWidget extends WidgetComponent<RootBlockModel> {
...
export const edgelessZoomToolbarWidget = WidgetViewExtension(
  ...
  literal`${unsafeStatic(NEXIO_EDGELESS_ZOOM_TOOLBAR_WIDGET)}`
);
