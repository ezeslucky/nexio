...
import { getRectByBlockComponent } from '@blocksuite/nexio-shared/utils';
import type { EdgelessSelectedRectWidget } from '@blocksuite/nexio-widget-edgeless-selected-rect';
