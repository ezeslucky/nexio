...
export const NEXIO_EDGELESS_REMOTE_SELECTION_WIDGET =
  'nexio-edgeless-remote-selection-widget';
...
export class EdgelessRemoteSelectionWidget extends WidgetComponent<RootBlockModel> {
  ...
  override render() {
    ...
    return html`
      <div class="nexio-edgeless-remote-selection">${rects}${cursors}</div>
    `;
  }
...
declare global {
  interface HTMLElementTagNameMap {
    [NEXIO_EDGELESS_REMOTE_SELECTION_WIDGET]: EdgelessRemoteSelectionWidget;
  }
}
