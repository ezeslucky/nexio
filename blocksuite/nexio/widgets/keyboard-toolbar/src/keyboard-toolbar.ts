...
import { type VirtualKeyboardProviderWithAction } from '@blocksuite/nexio-shared/services';
...
export const NEXIO_KEYBOARD_TOOLBAR = 'nexio-keyboard-toolbar';

@requiredProperties({
  config: PropTypes.object,
  rootComponent: PropTypes.instanceOf(BlockComponent),
})
export class NexioKeyboardToolbar extends SignalWatcher(
