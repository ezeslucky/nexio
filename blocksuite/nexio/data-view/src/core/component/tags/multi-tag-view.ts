...
export class MultiTagView extends WithDisposable(ShadowlessElement) {
  static override styles = css`
    ...
    .nexio-select-cell-container .select-selected {
      height: 22px;
      font-size: 14px;
      line-height: 20px;
      padding: 0 8px;
      border-radius: 4px;
      white-space: nowrap;
      background: var(--nexio-tag-white);
      overflow: hidden;
  ...
  override render() {
    ...
    return html`
      <div contenteditable="false" class="nexio-select-cell-container">
        ${repeat(values, id => {
  ...
  @query('.nexio-select-cell-container')
...
declare global {
  interface HTMLElementTagNameMap {
    'nexio-multi-tag-view': MultiTagView;
  }
}
