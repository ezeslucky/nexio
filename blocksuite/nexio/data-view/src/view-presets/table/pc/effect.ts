...
export function pcEffects() {
  ...
  customElements.define('nexio-data-view-table-group', TableGroup);
  customElements.define('dv-table-view-cell-container', TableViewCellContainer);
  customElements.define('nexio-database-column-header', DatabaseColumnHeader);
  customElements.define(
    'nexio-data-view-column-preview',
    DataViewColumnPreview
  );
  customElements.define('nexio-database-header-column', DatabaseHeaderColumn);
  customElements.define(
