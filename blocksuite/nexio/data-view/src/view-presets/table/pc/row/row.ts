...
export class TableRowView extends SignalWatcher(
  ...
  static override styles = css`
    .nexio-database-block-row:has(.row-select-checkbox.selected) {
      background: var(--nexio-primary-color-04);
    }
    .nexio-database-block-row:has(.row-select-checkbox.selected)
      .row-selected-bg {
      position: relative;
    ...
    .nexio-database-block-row.selected > .database-cell {
    ...
    .nexio-database-block-row .show-on-hover-row {
      visibility: hidden;
      opacity: 0;
    }
    .nexio-database-block-row:hover .show-on-hover-row {
      visibility: visible;
      opacity: 1;
    }
    .nexio-database-block-row:has(.active) .show-on-hover-row {
      visibility: visible;
      opacity: 1;
    }
    .nexio-database-block-row:has([data-editing='true']) .show-on-hover-row {
      visibility: hidden;
      opacity: 0;
    }
    ...
    .row-op {
      ...
      padding: 4px;
      border-radius: 4px;
      box-shadow: var(--nexio-button-shadow);
  ...
  get groupKey() {
    return this.closest<TableGroup>('nexio-data-view-table-group')?.group?.key;
  }
  ...
  override connectedCallback() {
    ...
    this.classList.add('nexio-database-block-row', 'database-row');
  }
            ...
            <div style="display: flex;">
              ...
              >
                <div
                  ...
                  border-radius: 2px;
                  height: 12px;
                  background-color: var(--nexio-placeholder-color);"
                ></div>
              </div>
              <row-select-checkbox
