...
export class DatabaseCellContainer extends SignalWatcher(
  ...
  static override styles = css`
    nexio-database-virtual-cell-container {
      display: flex;
      align-items: start;
      width: 100%;
      border: none;
    ...
    nexio-database-virtual-cell-container uni-lit > *:first-child {
      padding: 6px;
    }
  `;
  ...
  override connectedCallback() {
    ...
    if (style) {
      style.borderBottom = '1px solid var(--nexio-border-color)';
      style.borderRight = '1px solid var(--nexio-border-color)';
    }
  }
...
declare global {
  interface HTMLElementTagNameMap {
    'nexio-database-virtual-cell-container': DatabaseCellContainer;
  }
}
