...
export const datePickerStyle = css`
  ...
  .date-picker-small-action:hover {
    color: var(--nexio-icon-hover-color);
    background: var(--nexio-icon-hover-background);
  }
  ...
  .interactive::before {
    opacity: 0;
    transition: none;
    box-shadow: 0 0 0 3px var(--nexio-primary-color);
  }
  ...
  .interactive:focus-visible {
    outline: none;
    outline: 1px solid var(--nexio-primary-color);
  }
  ...
  .date-picker-footer {
    margin-top: 8px;
    padding-top: 8px;
    border-top: 1px solid var(--nexio-border-color);
  }
