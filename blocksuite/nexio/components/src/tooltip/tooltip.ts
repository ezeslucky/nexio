...
const styles = css`
  .nexio-tooltip {
    ...
    border-radius: 4px;
    padding: 6px 12px;
    color: var(--nexio-white);
    background: var(--nexio-tooltip);
...
const triangleMap = {
  top: {
    ...
    borderColor: 'var(--nexio-tooltip) transparent transparent transparent',
  },
  right: {
    left: '-6px',
    borderStyle: 'solid',
    borderWidth: '5px 6px 5px 0',
    borderColor: 'transparent var(--nexio-tooltip) transparent transparent',
  },
  bottom: {
    top: '-6px',
    borderStyle: 'solid',
    borderWidth: '0 5px 6px 5px',
    borderColor: 'transparent transparent var(--nexio-tooltip) transparent',
  },
  left: {
    right: '-6px',
    borderStyle: 'solid',
    borderWidth: '5px 0 5px 6px',
    borderColor: 'transparent transparent transparent var(--nexio-tooltip)',
  },
};
 ...
 * // Simple usage
 * html`
 * <nexio-tooltip>Content</nexio-tooltip>
 * `
 * // With placement
 * html`
 * <nexio-tooltip tip-position="top">
 *   Content
 * </nexio-tooltip>
 * `
 *
 ...
 *   .autoFlip=${true}
 *   .arrow=${true}
 *   .tooltipStyle=${css`:host { z-index: 0; --nexio-tooltip: #fff; }`}
...
export class Tooltip extends LitElement {
  ...
  @property({ attribute: false })
  accessor zIndex: number | string = 'var(--nexio-z-index-popover)';
}

declare global {
  interface HTMLElementTagNameMap {
    'nexio-tooltip': Tooltip;
  }
}
