import { PAGE_HEADER_HEIGHT } from '@blocksuite/nexio-shared/consts';
...
export class FilterableListComponent<Props = unknown> extends WithDisposable(
  ...
  override render() {
    ...
    return html`
      <div
        class=${classMap({ 'nexio-filterable-list': true, flipped: isFlip })}
      >
...
declare global {
  interface HTMLElementTagNameMap {
    'nexio-filterable-list': FilterableListComponent;
  }
}
