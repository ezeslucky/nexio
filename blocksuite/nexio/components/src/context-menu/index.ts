...
export function effects() {
  customElements.define('nexio-menu', MenuComponent);
  customElements.define('mobile-menu', MobileMenuComponent);
  customElements.define('nexio-menu-button', MenuButton);
  customElements.define('mobile-menu-button', MobileMenuButton);
  customElements.define('nexio-menu-input', MenuInput);
  customElements.define('mobile-menu-input', MobileMenuInput);
  customElements.define('nexio-menu-sub-menu', MenuSubMenu);
