import type { AliasInfo, LinkableEmbedModel } from '@blocksuite/nexio-model';
import {
  EmbedLinkedDocModel,
  EmbedSyncedDocModel,
...
import { fontSMStyle, fontXSStyle } from '@blocksuite/nexio-shared/styles';
...
export class EmbedCardEditModal extends SignalWatcher(
  ...
  static override styles = css`
    ...
    .embed-card-modal-wrapper {
      ...
      box-shadow: var(--nexio-overlay-shadow);
