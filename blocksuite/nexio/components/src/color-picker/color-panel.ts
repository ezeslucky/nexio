import type { Color, ColorScheme, Palette } from '@blocksuite/nexio-model';
import { DefaultTheme, resolveColor } from '@blocksuite/nexio-model';
import { unsafeCSSVarV2 } from '@blocksuite/nexio-shared/theme';
import { ColorEvent } from '@blocksuite/nexio-shared/utils';
...
export class EdgelessColorButton extends LitElement {
  static override styles = css`
    ...
    :host([active])::after {
      border: 1.5px solid var(--nexio-primary-color);
    }
  `;
