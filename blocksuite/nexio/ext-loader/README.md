...
```typescript
import { BaseExtensionProvider } from '@blocksuite/nexio-ext-loader';
import { z } from 'zod';
...
```typescript
import { StoreExtensionProvider, StoreExtensionManager } from '@blocksuite/nexio-ext-loader';
import { z } from 'zod';
...
```typescript
import { ViewExtensionProvider, ViewExtensionManager } from '@blocksuite/nexio-ext-loader';
import { z } from 'zod';
