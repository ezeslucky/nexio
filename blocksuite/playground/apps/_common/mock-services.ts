...
import type { BaseSelection, Workspace } from '@blocksuite/nexio/store';
...
export function mockDocModeService(editor: TestNexioEditorContainer) {
...
export function mockNotificationService(editor: TestNexioEditorContainer) {
