...
export class EmbedIframeIdleCard extends WithDisposable(LitElement) {
  static override styles = css`
    ...
    .nexio-embed-iframe-idle-card {
      container: nexio-embed-iframe-idle-card / size;
    ...
    .nexio-embed-iframe-idle-card:hover {
      cursor: pointer;
    }

    .nexio-embed-iframe-idle-card.horizontal {
      flex-direction: row;
    ...
    .nexio-embed-iframe-idle-card.vertical {
      ...
      @container nexio-embed-iframe-idle-card (height < 180px) {
        .icon {
          display: none;
        }
      }
  ...
  override render() {
    ...
    const cardClasses = classMap({
      'nexio-embed-iframe-idle-card': true,
