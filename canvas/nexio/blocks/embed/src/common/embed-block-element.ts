...
import type { EmbedCardStyle, EmbedProps } from '@canvas/nexio-model';
import {
  EMBED_CARD_HEIGHT,
...
import { findAncestorModel } from '@canvas/nexio-shared/utils';
import type { BlockService } from '@canvas/std';
import {
