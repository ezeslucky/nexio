import { LoadingIcon, OpenIcon } from '@canvas/nexio-components/icons';
import type {
  EmbedGithubModel,
  EmbedGithubStyles,
} from '@canvas/nexio-model';
import { ImageProxyService } from '@canvas/nexio-shared/adapters';
import { ThemeProvider } from '@canvas/nexio-shared/services';
import { BlockSelection, isGfxBlockComponent } from '@canvas/std';
  ...
  override renderBlock() {
    ...
    return this.renderEmbed(
      () => html`
        ...
        >
          <div class="nexio-embed-github-content">
            <div class="nexio-embed-github-content-title">
              <div class="nexio-embed-github-content-title-icons">
                <div class="nexio-embed-github-content-title-site-icon">
                  ${titleIcon}
                </div>
                ...
                ${status && statusText
                  ? html`<div
                      class=${classMap({
                        'nexio-embed-github-content-title-status-icon': true,
                        [githubType]: true,
                        [status]: true,
              ...
              <div class="nexio-embed-github-content-title-text">
                ${titleText}
              </div>
            </div>

            <div class="nexio-embed-github-content-description">
              ${descriptionText}
            </div>

            ${githubType === 'issue' && assignees
              ? html`
                  <div class="nexio-embed-github-content-assignees">
                    <div
                      class="nexio-embed-github-content-assignees-text label"
                    >
                      Assignees
                    </div>

                    <div
                      class="nexio-embed-github-content-assignees-text users"
                    >
                      ${assignees.length === 0
                        ? html`<span
                            class="nexio-embed-github-content-assignees-text-users placeholder"
                            >No one</span
                          >`
                        : repeat(
                            assignees,
                            ...
                            (assignee, index) =>
                              html`<span
                                  class="nexio-embed-github-content-assignees-text-users user"
                                  @click=${() =>
            ...
            <div class="nexio-embed-github-content-url" @click=${this.open}>
              <span class="nexio-embed-github-content-repo"
                >${`${owner}/${repo} |`}</span
              >

              ${createdAt
                ? html`<span class="nexio-embed-github-content-date"
                    >${dateText} |</span
                  >`
                : nothing}
              <span>github.com</span>

              <div class="nexio-embed-github-content-url-icon">
                ${OpenIcon}
              </div>
            </div>
          </div>
          <div class="nexio-embed-github-banner">${bannerImage}</div>
        </div>
      `
    );
  }
