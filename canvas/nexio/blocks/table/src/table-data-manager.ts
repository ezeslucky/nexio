import type { TableBlockModel, TableCell } from '@canvas/nexio-model';
import { generateFractionalIndexingKeyBetween } from '@canvas/nexio-shared/utils';
import { nanoid, Text } from '@canvas/store';
