...
} from '@canvas/nexio-block-database';
import {
...
import type { HighlightType } from '@canvas/nexio-components/highlight-dropdown-menu';
...
import { getMostCommonValue } from '@canvas/nexio-shared/utils';
import { tableViewMeta } from '@canvas/data-view/view-presets';
import {
  CopyIcon,
...
import { toDraftModel } from '@canvas/store';
      ...
      content: html`
        ...
        >
          <div data-size="large" data-orientation="vertical">
            ${repeat(
              textConversionConfigs.filter(c => c.flavour !== 'nexio:divider'),
              item => item.name,
