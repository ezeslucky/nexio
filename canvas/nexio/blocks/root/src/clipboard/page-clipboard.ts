import { deleteTextCommand } from '@canvas/nexio-inline-preset';
import {
  pasteMiddleware,
  replaceIdMiddleware,
  surfaceRefToEmbed,
...
import type { UIEventHandler } from '@canvas/std';
import type { BlockSnapshot, Store } from '@canvas/store';
...
export class PageClipboard extends ReadOnlyClipboard {
  static override key = 'nexio-page-clipboard';
