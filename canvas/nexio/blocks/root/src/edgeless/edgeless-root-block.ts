import { NoteConfigExtension } from '@canvas/nexio-block-note';
import {
  DefaultTool,
  getBgGridGap,
...
import { isSingleMindMapNode } from '@canvas/nexio-gfx-mindmap';
...
import { IS_WINDOWS } from '@canvas/global/env';
import { Bound, Point, Vec } from '@canvas/global/gfx';
import {
  BlockComponent,
...
> {
  ...
  get surfaceBlockModel() {
    return this.model.children.find(
      child => child.flavour === 'nexio:surface'
