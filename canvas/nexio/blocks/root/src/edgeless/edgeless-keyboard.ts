...
import { EdgelessTextBlockComponent } from '@canvas/nexio-block-edgeless-text';
import {
  FrameTool,
  type PresentToolOption,
} from '@canvas/nexio-block-frame';
import {
  DefaultTool,
...
import {
  ...
  EraserTool,
  HighlighterTool,
} from '@canvas/nexio-gfx-brush';
import {
  ConnectorTool,
  mountConnectorLabelEditor,
} from '@canvas/nexio-gfx-connector';
import {
  createGroupFromSelectedCommand,
  ungroupCommand,
} from '@canvas/nexio-gfx-group';
import {
  getNearestTranslation,
  isElementOutsideViewport,
  isSingleMindMapNode,
} from '@canvas/nexio-gfx-mindmap';
import { NoteTool } from '@canvas/nexio-gfx-note';
import { PanTool } from '@canvas/nexio-gfx-pointer';
import { mountShapeTextEditor, ShapeTool } from '@canvas/nexio-gfx-shape';
import { TextTool } from '@canvas/nexio-gfx-text';
import {
...
import { SurfaceSelection, TextSelection } from '@canvas/std';
import {
  type BaseTool,
