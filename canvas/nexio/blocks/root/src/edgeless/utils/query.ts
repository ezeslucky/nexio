import type { CanvasElementWithText } from '@canvas/nexio-block-surface';
import type { PanTool } from '@canvas/nexio-gfx-pointer';
import {
...
import { isTopLevelBlock } from '@canvas/nexio-shared/utils';
import type {
  GfxModel,
