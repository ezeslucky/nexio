...
export class ParagraphHeadingIcon extends SignalWatcher(
  ...
  static override styles = css`
    nexio-paragraph-heading-icon .heading-icon {
      display: flex;
      align-items: start;
      margin-top: 0.3em;
      position: absolute;
...
export function effects() {
  customElements.define('nexio-paragraph-heading-icon', ParagraphHeadingIcon);
}

declare global {
  interface HTMLElementTagNameMap {
    'nexio-paragraph-heading-icon': ParagraphHeadingIcon;
  }
}
