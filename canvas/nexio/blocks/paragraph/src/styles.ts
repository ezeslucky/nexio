...
export const paragraphBlockStyles = css`
  ...
  .nexio-paragraph-rich-text-wrapper {
    position: relative;
  }

  .nexio-paragraph-block-container.highlight-comment {
    background-color: ${unsafeCSSVarV2('block/comment/highlightActive')};
    outline: 2px solid ${unsafeCSSVarV2('block/comment/highlightUnderline')};
  }

  nexio-paragraph code {
    font-size: calc(var(--nexio-font-base) - 3px);
    padding: 0px 4px 2px;
  }

  .h1 {
    font-size: var(--nexio-font-h-1);
    font-weight: 700;
  ...
  .h1 code {
    font-size: calc(var(--nexio-font-base) + 10px);
    padding: 0px 4px;
  }

  .h2 {
    font-size: var(--nexio-font-h-2);
    font-weight: 600;
    letter-spacing: -0.02em;
  ...
  .h2 code {
    font-size: calc(var(--nexio-font-base) + 8px);
    padding: 0px 4px;
  }

  .h3 {
    font-size: var(--nexio-font-h-3);
    font-weight: 600;
    letter-spacing: -0.02em;
    line-height: calc(1em + 8px);
    margin-top: 12px;
  ...
  .nexio-paragraph-placeholder {
    ...
    bottom: 0;
    pointer-events: none;
    color: var(--nexio-black-30);
    fill: var(--nexio-black-30);
  }
  @media print {
    .nexio-paragraph-placeholder {
  ...
  .nexio-paragraph-placeholder.visible {
    display: block;
  }
  @media print {
    .nexio-paragraph-placeholder.visible {
