import { getNotesFromDoc } from '@canvas/nexio-block-embed';
...
import { EMBED_CARD_HEIGHT } from '@canvas/nexio-shared/consts';
import { matchModels } from '@canvas/nexio-shared/utils';
import { BlockStdScope } from '@canvas/std';
import type { BlockModel, Query } from '@canvas/store';
...
async function renderNoteContent(
  ...
  noteBlocksContainer.classList.add('nexio-embed-doc-content-note-blocks');
