...
import type { BlockComponent, UIEventStateContext } from '@canvas/std';
import {
  BlockSelection,
  ShadowlessElement,
  TextSelection,
...
export class ImageBlockPageComponent extends SignalWatcher(
  ...
  static override styles = css`
    ...
    nexio-page-image .nexio-image-status {
      position: absolute;
      left: 18px;
      bottom: 18px;
    }

    nexio-page-image .resizable-img {
      position: relative;
      max-width: 100%;
    }

    nexio-page-image .resizable-img img {
      width: 100%;
      height: 100%;
    }

    nexio-page-image .comment-highlighted {
...
declare global {
  interface HTMLElementTagNameMap {
    'nexio-page-image': ImageBlockPageComponent;
  }
}
