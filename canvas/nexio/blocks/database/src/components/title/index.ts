...
import type { DataViewUILogicBase } from '@canvas/data-view';
...
export class DatabaseTitle extends SignalWatcher(
  ...
  static override styles = css`
    ...
    .nexio-database-title .text {
      user-select: none;
      opacity: 0;
      white-space: pre-wrap;
    }

    .nexio-database-title[data-title-focus='false'] textarea {
      opacity: 0;
    }

    .nexio-database-title[data-title-focus='false'] .text {
    ...
    .nexio-database-title [data-title-empty='true']::before {
      content: 'Untitled';
      position: absolute;
      pointer-events: none;
      color: var(--nexio-text-primary-color);
    ...
    .nexio-database-title [data-title-focus='true']::before {
      color: var(--nexio-placeholder-color);
    }

    .nexio-database-title.comment-highlighted {
  ...
  get database() {
    return this.closest<DatabaseBlockComponent>('nexio-database');
  }
...
declare global {
  interface HTMLElementTagNameMap {
    'nexio-database-title': DatabaseTitle;
  }
}
