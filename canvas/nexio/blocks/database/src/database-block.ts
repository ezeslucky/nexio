...
import { getDropResult } from '@canvas/nexio-widget-drag-handle';
import {
  createRecordDetail,
...
import { Rect } from '@canvas/global/gfx';
import {
  CommentIcon,
  CopyIcon,
  DeleteIcon,
...
export class DatabaseBlockComponent extends CaptionedBlockComponent<DatabaseBlockModel> {
  ...
  private readonly renderTitle = (dataViewLogic: DataViewUILogicBase) => {
    return html` <nexio-database-title
...
declare global {
  interface HTMLElementTagNameMap {
    'nexio-database': DatabaseBlockComponent;
  }
}
