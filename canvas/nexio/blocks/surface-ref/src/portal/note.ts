import type { CanvasRenderer } from '@canvas/nexio-block-surface';
...
import { RANGE_QUERY_EXCLUDE_ATTR } from '@canvas/std/inline';
import { type BlockModel, type Query } from '@canvas/store';
...
export class SurfaceRefNotePortal extends WithDisposable(ShadowlessElement) {
  ...
  override render() {
    ...
    const style = {
      ...
      border: `${EDGELESS_BLOCK_CHILD_BORDER_WIDTH}px none var(--nexio-black-10)`,
      backgroundColor,
