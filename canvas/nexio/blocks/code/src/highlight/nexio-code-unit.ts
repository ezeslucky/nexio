...
import { ZERO_WIDTH_FOR_EMPTY_LINE } from '@canvas/std/inline';
...
export class NexioCodeUnit extends ShadowlessElement {
  get codeBlock() {
    return this.closest('nexio-code');
  }
  ...
  override render() {
    ...
    let style = this.delta.attributes
      ? nexioTextStyles(this.delta.attributes)
      : {};
