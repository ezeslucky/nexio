...
import { focusTextModel, type RichText } from '@canvas/nexio-rich-text';
import {
  BRACKET_PAIRS,
...
import { IS_MAC, IS_MOBILE } from '@canvas/global/env';
...
export class CodeBlockComponent extends CaptionedBlockComponent<CodeBlockModel> {
  ...
  override renderBlock(): TemplateResult<1> {
    ...
    return html`
      <div
        class=${classMap({
          'nexio-code-block-container': true,
      ...
      >
        ...
        <div
          ...
          class="nexio-code-block-preview"
        >
