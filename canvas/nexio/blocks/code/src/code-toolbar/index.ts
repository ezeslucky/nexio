...
export const NEXIO_CODE_TOOLBAR_WIDGET = 'nexio-code-toolbar-widget';
export class NexioCodeToolbarWidget extends WidgetComponent<
  CodeBlockModel,
  CodeBlockComponent
> {
  ...
  private readonly _setHoverController = () => {
    ...
    this._hoverController = new HoverController(
      ...
      ({ abortController }) => {
        ...
        return {
          template: html`<nexio-code-toolbar
            .context=${context}
