...
import type { DocTitle } from '@canvas/nexio-fragment-doc-title';
import { NoteBlockSchema, NoteDisplayMode } from '@canvas/nexio-model';
...
import { toGfxBlockComponent } from '@canvas/std';
import {
