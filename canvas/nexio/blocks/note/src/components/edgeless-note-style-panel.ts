...
import {
  ...
  type PickColorEvent,
  preprocessColor,
} from '@canvas/nexio-components/color-picker';
import type { LineDetailType } from '@canvas/nexio-components/edgeless-line-styles-panel';
import type { SliderSelectEvent } from '@canvas/nexio-components/slider';
import {
  DefaultTheme,
  NoteBlockModel,
  type NoteProps,
