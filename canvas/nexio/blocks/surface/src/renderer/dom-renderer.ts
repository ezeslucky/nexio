...
import { type BlockStdScope, SurfaceSelection } from '@canvas/std';
import type {
 ...
 *         (e.g., from `@canvas/nexio-block-surface` or its source).
 ...
 *
 * 5.  **Ensure Exports**:
 *     -   The `DomRenderer` class itself should be accessible (e.g., exported from `@canvas/nexio/blocks/surface`).
