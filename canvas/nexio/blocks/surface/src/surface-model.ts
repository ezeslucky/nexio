...
import type { SurfaceBlockProps } from '@canvas/std/gfx';
import { SurfaceBlockModel as BaseSurfaceModel } from '@canvas/std/gfx';
import { BlockSchemaExtension, defineBlockSchema } from '@canvas/store';
