import type { Color, ColorScheme, Palette } from '@canvas/nexio-model';
import { DefaultTheme, resolveColor } from '@canvas/nexio-model';
import { unsafeCSSVarV2 } from '@canvas/nexio-shared/theme';
import { ColorEvent } from '@canvas/nexio-shared/utils';
