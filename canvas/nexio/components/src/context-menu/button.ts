...
export class MenuButton extends MenuFocusable {
  static override styles = css`
    ...
    .nexio-menu-button:hover,
    nexio-menu-button.active .nexio-menu-button {
      background-color: var(--nexio-hover-color);
    }

    .nexio-menu-button .nexio-menu-action-text {
      flex: 1;
      font-size: 14px;
      line-height: 22px;
    ...
    .nexio-menu-button.focused {
      outline: 1px solid ${unsafeCSS(cssVarV2.layer.insideBorder.primaryBorder)};
    }

    .nexio-menu-button.delete-item:hover {
      background-color: var(--nexio-background-error-color);
      color: var(--nexio-error-color);
    }

    .nexio-menu-button.delete-item:hover .nexio-menu-action-text {
      color: var(--nexio-error-color);
    }
  `;
...
export class MobileMenuButton extends MenuFocusable {
  static override styles = css`
    ...
    .mobile-menu-button .nexio-menu-action-text {
      flex: 1;
      color: var(--nexio-text-primary-color);
      font-size: 17px;
      line-height: 22px;
    ...
    menu => {
      ...
      const data: MenuButtonData = {
        content: () => {
          return html`
            ${config.prefix}
            <div class="nexio-menu-action-text">
