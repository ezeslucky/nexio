...
export class NexioLatexNode extends SignalWatcher(
  ...
  static override styles = css`
    ...
    nexio-latex-node .nexio-latex:hover {
      background: ${unsafeCSSVar('hoverColor')};
    }
    nexio-latex-node .nexio-latex[data-selected='true'] {
      background: ${unsafeCSSVar('hoverColor')};
    }

    nexio-latex-node .error-placeholder {
      display: flex;
      padding: 2px 4px;
  ...
  override render() {
    return html`<span class="nexio-latex" data-selected=${this.selected}
  ...
  @property({ attribute: false })
  accessor editor!: InlineEditor<NexioTextAttributes>;
