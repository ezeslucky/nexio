import { insertLinkedNode } from '@canvas/nexio-inline-reference';
import { CodeBlockModel } from '@canvas/nexio-model';
import { getInlineEditorByModel } from '@canvas/nexio-rich-text';
import { BRACKET_PAIRS } from '@canvas/nexio-shared/consts';
