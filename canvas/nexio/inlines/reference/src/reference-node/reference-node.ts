import { whenHover } from '@canvas/nexio-components/hover';
...
import { nexioTextStyles } from '@canvas/nexio-shared/styles';
...
import type { DeltaInsert, DocMeta, Store } from '@canvas/store';
