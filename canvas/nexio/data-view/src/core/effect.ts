...
export function coreEffects() {
  ...
  customElements.define('nexio-lit-icon', NexioLitIcon);
  customElements.define('data-view-group-setting', GroupSetting);
  customElements.define('nexio-multi-tag-select', MultiTagSelect);
  customElements.define('data-view-group-title-boolean-view', BooleanGroupView);
  customElements.define('nexio-multi-tag-view', MultiTagView);
  ...
  customElements.define('nexio-data-view-record-detail', RecordDetail);
}
