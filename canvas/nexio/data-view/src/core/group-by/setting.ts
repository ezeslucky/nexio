  ...
  protected override render(): unknown {
    ...
    return html`
      <div style="padding: 7px 0;">
        <div
          style="padding: 0 4px; font-size: 12px;color: var(--nexio-text-secondary-color);line-height: 20px;"
        >
          Groups
        </div>
        <div></div>
        ...
        menu.group({
          items: [
            menu.subMenu({
              ...
              postfix: html`
                <div
                  style="display:flex;align-items:center;gap: 4px;font-size: 12px;line-height: 20px;color: var(--nexio-text-secondary-color);margin-right: 4px;margin-left: 8px;"
                  class="dv-icon-16"
                >
