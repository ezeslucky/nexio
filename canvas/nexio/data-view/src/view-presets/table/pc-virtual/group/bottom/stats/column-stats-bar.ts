...
const styles = css`
  nexio-database-virtual-column-stats {
  ...
  protected override render() {
    ...
    return html`
      ${repeat(
        ...
        col => col.id,
        col => {
          return html`<nexio-database-virtual-column-stats-cell
            .column=${col}
            .group=${this.group}
          ></nexio-database-virtual-column-stats-cell>`;
        }
      )}
    `;
  }
...
declare global {
  interface HTMLElementTagNameMap {
    'nexio-database-virtual-column-stats': VirtualDataBaseColumnStats;
  }
}
