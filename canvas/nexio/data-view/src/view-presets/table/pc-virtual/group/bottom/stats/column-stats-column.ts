...
const styles = css`
  ...
  nexio-database-virtual-column-stats:hover .stats-cell {
    opacity: 1;
  }

  .stats-cell:hover,
  nexio-database-virtual-column-stats-cell.active .stats-cell {
    opacity: 1;
...
declare global {
  interface HTMLElementTagNameMap {
    'nexio-database-virtual-column-stats-cell': VirtualDatabaseColumnStatsCell;
  }
}
