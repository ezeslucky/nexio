...
const styles = css`
  ...
  nexio-database-column-stats:hover .stats-cell {
    opacity: 1;
  }

  .stats-cell:hover,
  nexio-database-column-stats-cell.active .stats-cell {
    opacity: 1;
...
declare global {
  interface HTMLElementTagNameMap {
    'nexio-database-column-stats-cell': DatabaseColumnStatsCell;
  }
}
