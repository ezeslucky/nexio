...
const styles = css`
  ...
  nexio-data-view-kanban-group:hover .group-header-op {
    visibility: visible;
    opacity: 1;
  }
  ...
  nexio-data-view-kanban-group:hover .add-card {
    visibility: visible;
    opacity: 1;
  }

  nexio-data-view-kanban-group .add-card:hover {
...
declare global {
  interface HTMLElementTagNameMap {
    'nexio-data-view-kanban-group': KanbanGroup;
  }
}
