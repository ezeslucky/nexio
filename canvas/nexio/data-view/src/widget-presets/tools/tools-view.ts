...
const styles = css`
  ...
  .toolbar-hover-container:hover .nexio-database-toolbar {
    visibility: visible;
    opacity: 1;
  }
  .toolbar-hover-container:has(.active) .nexio-database-toolbar {
    visibility: visible;
    opacity: 1;
  }
