import type { DomRenderer } from '@canvas/nexio-block-surface';
import { isRTL } from '@canvas/nexio-gfx-text';
import type { ShapeElementModel } from '@canvas/nexio-model';
import { DefaultTheme } from '@canvas/nexio-model';
import { SVGShapeBuilder } from '@canvas/global/gfx';
