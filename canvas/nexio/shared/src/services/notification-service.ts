import { createIdentifier, type ServiceProvider } from '@canvas/global/di';
import { EditorLifeCycleExtension } from '@canvas/std';
import { type ExtensionType, StoreIdentifier } from '@canvas/store';
