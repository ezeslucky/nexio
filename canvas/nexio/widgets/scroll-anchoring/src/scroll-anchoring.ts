...
import { Bound, deserializeXYWH } from '@canvas/global/gfx';
...
export const NEXIO_SCROLL_ANCHORING_WIDGET = 'nexio-scroll-anchoring-widget';

export class NexioScrollAnchoringWidget extends WidgetComponent {
  ...
  #moveToAnchorInEdgeless(id: string) {
    ...
    if (parentComponent && parentComponent.flavour === 'nexio:note') {
