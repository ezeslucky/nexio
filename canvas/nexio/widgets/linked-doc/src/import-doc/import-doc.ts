...
import type { ExtensionType, Schema, Workspace } from '@canvas/store';
...
export class ImportDoc extends WithDisposable(LitElement) {
  ...
  private _openLearnImportLink(event: MouseEvent) {
    event.stopPropagation();
    window.open(
      'https://nexio.pro/blog/import-your-data-from-notion-into-nexio',
      '_blank'
    );
  }
  ...
  override render() {
    ...
    return html`
      ...
      <div class="container">
        ...
        <div>
          NEXIO will gradually support more file formats for import.
          <a
        ...
        <div class="button-container">
          ...
          >
            ...
            >
              ${HelpIcon}
              <nexio-tooltip>
                Learn how to Import your Notion pages into NEXIO.
              </nexio-tooltip>
            </div>
          </icon-button>
        ...
        <!-- <div class="footer">
        <div>Migrate from other versions of NEXIO?</div>
      </div> -->
      </div>
    `;
  }
