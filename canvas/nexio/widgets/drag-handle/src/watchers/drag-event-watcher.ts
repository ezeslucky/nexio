...
} from '@canvas/nexio-block-embed';
import { ParagraphBlockComponent } from '@canvas/nexio-block-paragraph';
import { DropIndicator } from '@canvas/nexio-components/drop-indicator';
import {
...
import { surfaceRefToEmbed } from '@canvas/nexio-shared/adapters';
import {
