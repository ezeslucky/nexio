...
import { getSelectionRectsCommand } from '@canvas/nexio-shared/commands';
import { EMBED_BLOCK_MODEL_LIST } from '@canvas/nexio-shared/consts';
...
import type { BaseSelection, UserInfo } from '@canvas/store';
...
export const NEXIO_DOC_REMOTE_SELECTION_WIDGET =
  'nexio-doc-remote-selection-widget';

export class NexioDocRemoteSelectionWidget extends WidgetComponent {
                ...
                >
                  <div
                    style="${styleMap({
                      ...
                      maxWidth: '160px',
                      padding: '0 3px',
                      border: '1px solid var(--nexio-pure-black-20)',
...
declare global {
  interface HTMLElementTagNameMap {
    [NEXIO_DOC_REMOTE_SELECTION_WIDGET]: NexioDocRemoteSelectionWidget;
  }
}
