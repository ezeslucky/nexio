...
import { mountShapeTextEditor } from '@canvas/nexio-gfx-shape';
import type {
  Connection,
...
import { ToolbarRegistryIdentifier } from '@canvas/nexio-shared/services';
import type { SelectedRect } from '@canvas/nexio-shared/types';
import { handleNativeRangeAtPoint } from '@canvas/nexio-shared/utils';
import { DisposableGroup } from '@canvas/global/disposable';
import type { Bound, IVec } from '@canvas/global/gfx';
import { Vec } from '@canvas/global/gfx';
...
export class EdgelessAutoComplete extends WithDisposable(LitElement) {
  static override styles = css`
    ...
    .edgeless-auto-complete-arrow-wrapper
      ...
      border: 1px solid var(--nexio-white-10);
      box-shadow: var(--nexio-shadow-1);
