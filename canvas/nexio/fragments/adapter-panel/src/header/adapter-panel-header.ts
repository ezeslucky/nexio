...
import { ArrowDownSmallIcon, FlipDirectionIcon } from '@canvas/icons/lit';
...
export const NEXIO_ADAPTER_PANEL_HEADER = 'nexio-adapter-panel-header';
...
export class AdapterPanelHeader extends SignalWatcher(LitElement) {
  ...
  private readonly _toggleAdapterMenu = () => {
    ...
    createLitPortal({
      template: html`<nexio-adapter-menu
...
declare global {
  interface HTMLElementTagNameMap {
    [NEXIO_ADAPTER_PANEL_HEADER]: AdapterPanelHeader;
  }
}
