...
import { SettingsIcon, SortIcon } from '@canvas/icons/lit';
...
export const NEXIO_OUTLINE_PANEL_HEADER = 'nexio-outline-panel-header';
  ...
  override render() {
    ...
    return html`<div class=${styles.container}>
      ...
      <div class=${styles.notePreviewSettingContainer}>
        <nexio-outline-note-preview-setting-menu></nexio-outline-note-preview-setting-menu>
      </div>`;
  }
...
declare global {
  interface HTMLElementTagNameMap {
    [NEXIO_OUTLINE_PANEL_HEADER]: OutlinePanelHeader;
  }
}
