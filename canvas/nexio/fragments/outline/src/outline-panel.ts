...
export const NEXIO_OUTLINE_PANEL = 'nexio-outline-panel';
...
export class OutlinePanel extends SignalWatcher(
  ...
  override render() {
    ...
    return html`
      <nexio-outline-panel-header></nexio-outline-panel-header>
      <nexio-outline-panel-body> </nexio-outline-panel-body>
      <nexio-outline-notice></nexio-outline-notice>
    `;
  }
...
declare global {
  interface HTMLElementTagNameMap {
    [NEXIO_OUTLINE_PANEL]: OutlinePanel;
  }
}
