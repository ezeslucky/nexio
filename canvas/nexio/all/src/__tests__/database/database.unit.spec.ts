...
describe('DatabaseManager', () => {
  ...
  const selection = [
    { id: '1', value: 'Done', color: 'var(--nexio-tag-white)' },
    { id: '2', value: 'TODO', color: 'var(--nexio-tag-pink)' },
    { id: '3', value: 'WIP', color: 'var(--nexio-tag-blue)' },
  ];
  ...
  beforeEach(() => {
    ...
    noteBlockId = doc.addBlock('nexio:note', {}, rootId);
