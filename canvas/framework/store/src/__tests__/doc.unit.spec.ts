...
test('query', () => {
  ...
  const page = store1.addBlock('nexio:page');
  const note = store1.addBlock('nexio:note', {}, page);
  const paragraph1 = store1.addBlock('nexio:paragraph', {}, note);
  const list1 = store1.addBlock('nexio:list' as never, {}, note);
  ...
  const list2 = store1.addBlock('nexio:list' as never, {}, note);
