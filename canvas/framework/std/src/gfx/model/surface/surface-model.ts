...
import { assertType, type Constructor } from '@canvas/global/utils';
import type { Boxed } from '@canvas/store';
import { BlockModel, nanoid } from '@canvas/store';
 ...
 * Used for text field
 */
export const SURFACE_TEXT_UNIQ_IDENTIFIER = 'nexio:surface:text';
/**
 * Used for field that use Y.Map. E.g. group children field
 */
export const SURFACE_YMAP_UNIQ_IDENTIFIER = 'nexio:surface:ymap';
