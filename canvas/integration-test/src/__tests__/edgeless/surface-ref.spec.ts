...
import type { DocSnapshot } from '@canvas/store';
...
import type { FrameBlockComponent } from '@canvas/nexio/blocks/frame';
...
describe('clipboard', () => {
  test('import surface-ref snapshot should render content correctly', async () => {
    ...
    const surfaceRefs = newDoc!.getBlocksByFlavour('nexio:surface-ref');
