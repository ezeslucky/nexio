...
update_app_stream_version() {
  ...
  #     <url>https://github.com/ezeslucky/nexio.git/releases/tag/v0.21.0</url>
  #   </release>
  # </releases>
  ...
  sed -i.bak -E "s|<url>https://github.com/ezeslucky/nexio.git/releases/tag/v[^<]*</url>|<url>https://github.com/ezeslucky/nexio.git/releases/tag/v$new_version</url>|" "$file_path"
