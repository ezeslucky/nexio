...
export default tseslint.config(
  ...
  },
  {
    ...
    rules: {
      ...
      'sonarjs/no-same-line-iteration': 'error',
  ...
  },
  {
    ...
    rules: {
      'import-x/no-extraneous-dependencies': [
        'error',
        { includeInternal: true, whitelist: ['@nexio/admin'] },
      ],
    },
  },
  {
    ...
    rules: {
      'import-x/no-extraneous-dependencies': [
        'error',
        { includeInternal: true, whitelist: ['@nexio/core'] },
      ],
    },
  },
  {
    ...
    rules: {
      'import-x/no-extraneous-dependencies': [
        'error',
        { includeInternal: true, whitelist: ['@nexio/component'] },
      ],
    },
  },
  {
