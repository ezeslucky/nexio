...
describe('framework', () => {
  ...
  test('scope', () => {
    ...
    expect(root.get(SystemService).appName).toEqual('nexio');
    ...
    expect(workspaceService.system.appName).toEqual('nexio');
    ...
    expect(pageService.system.appName).toEqual('nexio');
