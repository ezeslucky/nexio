...
```ts
import type { ConnectionStatus } from '@nexio/nbstore';
import { IndexedDBDocStorage } from '@nexio/nbstore/idb';
...
```ts
import { SpaceStorage } from '@nexio/nbstore';
import type { ConnectionStatus } from '@nexio/nbstore';
import { IndexedDBDocStorage } from '@nexio/nbstore/idb';
import { SqliteBlobStorage } from '@nexio/nbstore/sqlite';
...
```ts
import { SpaceStorageWorkerClient } from '@nexio/nbstore/op';
import type { ConnectionStatus } from '@nexio/nbstore';
import { IndexedDBDocStorage } from '@nexio/nbstore/idb';
