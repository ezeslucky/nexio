...
defineModuleConfig('indexer', {
  ...
  'provider.apiKey': {
    ...
    default: '',
    env: ['NEXIO_INDEXER_SEARCH_API_KEY', 'string'],
  },
  'provider.username': {
