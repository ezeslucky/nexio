  ...
  await indexerService.write(
    ...
    [
      ...
      },
      {
        ...
        ref: [
          '{"type": "nexio:page", "id": "docId2"}',
          '{"type": "nexio:page", "id": "docId1"}',
        ],
      },
    ],
    {
    ...
    query: {
      ...
      queries: [
        ...
        },
        {
          ...
          field: 'content',
          match:
            'For developers or installations guides, please go to NEXIO Doc',
        },
      ],
    },
    options: {
