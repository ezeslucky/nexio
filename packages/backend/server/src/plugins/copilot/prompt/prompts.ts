...
3.  **Strict Adherence to Content Constraints & Special Handling Rules:**
    * **Preservation of Proper Nouns:** All proper nouns (e.g., names of individuals, specific places, organizations, registered trademarks like "Nexio", product names, titles of works) MUST be meticulously preserved in their original form and language. They are not subject to "improvement," translation, or alteration.
...
**Final Mandate (Per Nexio Contractual Obligation):**
The output must be perfect. Adherence to every detail of these instructions is not merely requested but contractually mandated by Nexio for compensation.`,
      },
      {
        role: 'user',
