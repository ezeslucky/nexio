  ...
  const actual = {
    whitelist: {
      proMonthly: resolveProductMapping({
        productId: 'app.nexio.pro.Monthly',
      }),
      proAnnual: resolveProductMapping({ productId: 'app.nexio.pro.Annual' }),
      aiAnnual: resolveProductMapping({
        productId: 'app.nexio.pro.ai.Annual',
      }),
    },
    override: {
  ...
  const subscriber = mockSub([
    {
      ...
      productId: 'app.nexio.pro.Annual',
      store: 'app_store',
      willRenew: true,
      duration: null,
    },
