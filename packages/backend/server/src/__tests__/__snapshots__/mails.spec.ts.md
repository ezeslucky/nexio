        ...
        <tr>␊
          <td>␊
            <p␊
              ...
              This is a test email from your Orbit instance.␊
            </p>␊
          </td>␊
        </tr>␊
      </tbody>␊
            ...
            <table␊
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <p␊
                    style="font-size:15px;line-height:24px;font-weight:400;font-family:Inter, Arial, Helvetica, sans-serif;margin-top:24px;margin-bottom:0;color:#141414">␊
                    You are signing in to Orbit. Here is your code:␊
                  </p>␊
                </tr>␊
              </tbody>␊
            </table>␊
    ...
    123456</pre␊
            ...
            <table␊
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <a␊
                    href="https://app.nexio.pro/magic-link?token=123456&amp;email=test@test.com"␊
...
> Your Orbit account is waiting for you!
            ...
            <table␊
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <p␊
                    style="font-size:15px;line-height:24px;font-weight:400;font-family:Inter, Arial, Helvetica, sans-serif;margin-top:24px;margin-bottom:0;color:#141414">␊
                    You are signing up to Orbit. Here is your code:␊
                  </p>␊
                </tr>␊
              </tbody>␊
            </table>␊
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <p␊
                    ...
                    with your Orbit account.<br />To complete this process, please␊
      ...
      <tbody>␊
        <tr>␊
          <td>␊
            <p␊
              style="font-size:20px;line-height:28px;font-weight:600;font-family:Inter, Arial, Helvetica, sans-serif;margin-top:24px;margin-bottom:0;color:#141414">␊
              Verify your current email for Orbit␊
            </p>␊
          </td>␊
        </tr>␊
      </tbody>␊
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <p␊
                    style="font-size:15px;line-height:24px;font-weight:400;font-family:Inter, Arial, Helvetica, sans-serif;margin-top:24px;margin-bottom:0;color:#141414">␊
                    You recently requested to change the email address associated␊
                    with your Orbit account. To complete this process, please click␊
        ...
        <tr>␊
          <td>␊
            <p␊
              ...
              you&#x27;re using␊
              <span style="font-weight:600">test@nexio.pro</span> to log in the␊
              next time.␊
            </p>␊
          </td>␊
        </tr>␊
...
> test@test.com invited you to join Test Workspace
    ...
    <link␊
      rel="preload"␊
      as="image"␊
      href="https://app.nexio.pro/favicon-192.png" /><!--$-->␊
    <table␊
      align="center"␊
      width="100%"␊
      border="0"␊
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <p␊
                    ...
                    to join␊
                    <img␊
                      src="https://app.nexio.pro/favicon-192.png"␊
                      alt="avatar"␊
            ...
            <table␊
              ...
              <tbody style="width:100%">␊
                <tr style="width:100%">␊
                  <p␊
                    style="font-size:15px;line-height:24px;font-weight:400;font-family:Inter, Arial, Helvetica, sans-serif;margin-top:24px;margin-bottom:0;color:#141414">␊
                    Thank you for your support of NEXIO. We hope to see you again␊
                    in the future.␊
                  </p>␊
                </tr>␊
              </tbody>␊
...
> Your Orbit Self-Hosted Team Workspace license is ready
