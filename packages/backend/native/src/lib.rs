...
#[napi]
pub const NEXIO_PRO_PUBLIC_KEY: Option<&'static str> = std::option_env!("NEXIO_PRO_PUBLIC_KEY");

#[napi]
pub const NEXIO_PRO_LICENSE_AES_KEY: Option<&'static str> =
  std::option_env!("NEXIO_PRO_LICENSE_AES_KEY");