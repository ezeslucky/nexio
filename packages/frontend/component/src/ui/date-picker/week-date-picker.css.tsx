...
export const dayCell = style({
  ...
  selectors: {
    ...
    '&::before': {
      boxShadow: '0 0 0 2px var(--nexio-brand-color)',
    },
    '&::after': {
      border: '1px solid var(--nexio-brand-color)',
    },
...
export const dayCellWeek = style({
  ...
  whiteSpace: 'nowrap',
  overflow: 'hidden',
  color: 'var(--cell-color, var(--nexio-text-secondary-color))',
});
export const dayCellDate = style({
  ...
  color: 'var(--cell-color, var(--nexio-text-primary-color))',
});
