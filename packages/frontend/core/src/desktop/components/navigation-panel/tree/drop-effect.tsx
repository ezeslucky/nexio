...
export const DropEffect = ({
  ...
  return createPortal(
    ...
    >
      ...
      {dropEffect === 'copy'
        ? t['com.nexio.rootAppSidebar.explorer.drop-effect.copy']()
        : dropEffect === 'move'
          ? t['com.nexio.rootAppSidebar.explorer.drop-effect.move']()
          : t['com.nexio.rootAppSidebar.explorer.drop-effect.link']()}
    </div>,
    document.body
  );
};
