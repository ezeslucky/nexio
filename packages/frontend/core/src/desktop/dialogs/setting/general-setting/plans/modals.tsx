...
export const ConfirmLoadingModal = ({
  ...
  const title = t[`com.nexio.payment.modal.${type}.title`]();
  const confirmText = t[`com.nexio.payment.modal.${type}.confirm`]();
  const cancelText = t[`com.nexio.payment.modal.${type}.cancel`]();
  const contentText =
    type !== 'change' ? t[`com.nexio.payment.modal.${type}.content`]() : '';
...
export const DowngradeModal = ({
  ...
  return (
    <Modal
      title={t['com.nexio.payment.modal.downgrade.title']()}
      open={open}
      contentOptions={{}}
      width={480}
      onOpenChange={onOpenChange}
    >
      <div className={styles.downgradeContentWrapper}>
        <p className={styles.downgradeContent}>
          {t['com.nexio.payment.modal.downgrade.content']()}
        </p>
        <p className={styles.downgradeCaption}>
          {t['com.nexio.payment.modal.downgrade.caption']()}
        </p>
      </div>
      ...
      <footer className={styles.downgradeFooter}>
        <Button
          ...
          loading={loading}
        >
          {t['com.nexio.payment.modal.downgrade.cancel']()}
        </Button>
        <DialogTrigger asChild>
          <Button
            ...
            variant="primary"
          >
            {t['com.nexio.payment.modal.downgrade.confirm']()}
          </Button>
        </DialogTrigger>
      </footer>
    </Modal>
      ...
      <footer className={styles.downgradeFooter}>
        ...
        <DialogTrigger asChild>
          <Button
            ...
            variant="primary"
          >
            {t['com.nexio.payment.modal.downgrade.team-confirm']()}
          </Button>
        </DialogTrigger>
      </footer>
    </Modal>
