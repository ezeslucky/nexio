...
export const AIPlan = () => {
  ...
  const billingTip = subscription?.nextBillAt
    ? t['com.nexio.payment.ai.billing-tip.next-bill-at']({
        due: i18nTime(subscription.nextBillAt, {
          absolute: { accuracy: 'day' },
        }),
      })
    : subscription?.canceledAt && subscription.end
      ? t['com.nexio.payment.ai.billing-tip.end-at']({
  ...
  return (
    <AIPlanLayout
      caption={
        subscription
          ? t['com.nexio.payment.ai.pricing-plan.caption-purchased']()
          : t['com.nexio.payment.ai.pricing-plan.caption-free']()
      }
      actionButtons={
        isLoggedIn ? (
          subscription ? (
            ...
            <>
              ...
              />
              <a href="https://ai.nexio.pro" target="_blank" rel="noreferrer">
                <Button className={styles.learnAIButton}>
                  {t['com.nexio.payment.ai.pricing-plan.learn']()}
                </Button>
              </a>
            </>
          )
