      ...
      <header className={styles.believerHeader}>
        <div>
          <div className={styles.believerTitle}>
            {t['com.nexio.payment.billing-setting.believer.title']()}
          </div>
          <div className={styles.believerSubtitle}>
            <Trans
              i18nKey={
                'com.nexio.payment.billing-setting.believer.description'
              }
              components={{
        ...
        <div className={styles.believerPriceWrapper}>
          ...
          <div className={styles.believerPriceCaption}>
            {t['com.nexio.payment.billing-setting.believer.price-caption']()}
          </div>
        </div>
      </header>
      <BelieverBenefits />
