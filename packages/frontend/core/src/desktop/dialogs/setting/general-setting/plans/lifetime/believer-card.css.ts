...
globalStyle(`.${bg} > svg.nexio-svg`, {
  vars: {
    [nexioIconGradientStart]: colorSchemes.light.nexio.start,
    [nexioIconGradientStop]: colorSchemes.light.nexio.stop,
  },
  position: 'absolute',
  zIndex: 0,
});
globalStyle(`[data-theme='dark'] .${bg} > svg.nexio-svg`, {
  vars: {
    [nexioIconGradientStart]: colorSchemes.dark.nexio.start,
    [nexioIconGradientStop]: colorSchemes.dark.nexio.stop,
  },
});
...
// --------- style1 ---------
globalStyle(`.${card}[data-type="1"] .${bg} > svg.nexio-svg`, {
  right: -150,
  top: -100,
});
...
// --------- style2 ---------
globalStyle(`.${card}[data-type="2"] .${bg} > svg.nexio-svg`, {
  position: 'absolute',
  right: -140,
  bottom: -130,
