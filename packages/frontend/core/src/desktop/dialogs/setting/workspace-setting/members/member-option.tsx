...
export const MemberOptions = ({
  ...
  const openRemoveConfirmModal = useCallback(
    (successNotify: { title: string; message: string }) => {
      openConfirmModal({
        title: t['com.nexio.payment.member.team.remove.confirm.title'](),
        description:
          t['com.nexio.payment.member.team.remove.confirm.description'](),
        confirmText:
          t['com.nexio.payment.member.team.remove.confirm.confirm-button'](),
        cancelText: t['com.nexio.payment.member.team.remove.confirm.cancel'](),
  ...
  const handleRevoke = useCallback(() => {
    openRemoveConfirmModal({
      title: t['com.nexio.payment.member.team.revoke.notify.title'](),
      message: t['com.nexio.payment.member.team.revoke.notify.message']({
  ...
  const handleApprove = useCallback(() => {
    membersService
      ...
      .then(result => {
        if (result) {
          notify.success({
            title: t['com.nexio.payment.member.team.approve.notify.title'](),
            message: t['com.nexio.payment.member.team.approve.notify.message'](
              {
                name: member.name || member.email || member.id,
              }
            ),
  ...
  const handleDecline = useCallback(() => {
    openRemoveConfirmModal({
      title: t['com.nexio.payment.member.team.decline.notify.title'](),
      message: t['com.nexio.payment.member.team.decline.notify.message']({
        name: member.name || member.email || member.id,
      }),
    });
  ...
  const handleRemove = useCallback(() => {
    openRemoveConfirmModal({
      title: t['com.nexio.payment.member.team.remove.notify.title'](),
      message: t['com.nexio.payment.member.team.remove.notify.message']({
        name: member.name || member.email || member.id,
      }),
    });
  }, [member, openRemoveConfirmModal, t]);
  ...
  const handleChangeToAdmin = useCallback(() => {
    membersService
      ...
      .then(result => {
        if (result) {
          notify.success({
            title: t['com.nexio.payment.member.team.change.notify.title'](),
            message: t[
              'com.nexio.payment.member.team.change.admin.notify.message'
            ]({
              name: member.name || member.email || member.id,
            }),
          });
      ...
      .then(result => {
        if (result) {
          notify.success({
            title: t['com.nexio.payment.member.team.change.notify.title'](),
            message: t[
              'com.nexio.payment.member.team.change.collaborator.notify.message'
            ]({
              name: member.name || member.email || member.id,
            }),
          });
  ...
  const handleRetryPayment = useCallback(() => {
    openConfirmModal({
      ...
      description:
        t[
          `com.nexio.payment.member.team.retry-payment.${isOwner ? 'owner' : 'admin'}.description`
        ](),
      confirmText:
        t[
          isOwner
            ? 'com.nexio.payment.member.team.retry-payment.update-payment'
            : 'Got it'
        ](),
      confirmButtonOptions: {
        variant: 'primary',
  ...
  const operationButtonInfo = useMemo(() => {
    return [
      {
        label: t['com.nexio.payment.member.team.retry-payment'](),
        onClick: handleRetryPayment,
        show: member.status === WorkspaceMemberStatus.NeedMoreSeat,
      },
      {
        label: t['com.nexio.payment.member.team.approve'](),
      ...
      {
        label: t['com.nexio.payment.member.team.decline'](),
      ...
      {
        label: t['com.nexio.payment.member.team.revoke'](),
      ...
      {
        label: t['com.nexio.payment.member.team.remove'](),
      ...
      {
        label: t['com.nexio.payment.member.team.change.collaborator'](),
      ...
      {
        label: t['com.nexio.payment.member.team.change.admin'](),
      ...
      {
        label: t['com.nexio.payment.member.team.assign'](),
