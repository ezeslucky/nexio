  ...
  return (
    <>
      <IntegrationSettingHeader
        icon={<TodayIcon />}
        name={t['com.nexio.integration.calendar.name']()}
        desc={t['com.nexio.integration.calendar.desc']()}
        divider={false}
      />
...
const AddSubscription = () => {
  ...
  const handleAddSub = useCallback(() => {
    ...
    if (exists) {
      notify.error({
        title: t['com.nexio.integration.calendar.new-duplicate-error-title'](),
        message:
          t['com.nexio.integration.calendar.new-duplicate-error-content'](),
      });
      return;
    }
    ...
    calendar
      ...
      .catch(() => {
        notify.error({
          title: t['com.nexio.integration.calendar.new-error'](),
        });
      })
      .finally(() => {
        setVerifying(false);
  ...
  return (
    <>
      ...
      >
        {t['com.nexio.integration.calendar.new-subscription']()}
      </Button>
      <Modal
        open={open}
      ...
      >
        <header className={styles.newDialogHeader}>
          ...
          <div className={styles.newDialogTitle}>
            {t['com.nexio.integration.calendar.new-title']()}
          </div>
        </header>

        <div className={styles.newDialogContent}>
          <div className={styles.newDialogLabel}>
            {t['com.nexio.integration.calendar.new-url-label']()}
          </div>
          <Input
            type="text"
            value={url}
