...
export const DatabaseRendererTypes = {
  ...
  link: {
    Icon: LinkIcon,
    Renderer: LinkCell,
    name: 'com.nexio.page-properties.property.link',
  },
  progress: {
    Icon: ProgressIcon,
    Renderer: ProgressCell,
    name: 'com.nexio.page-properties.property.progress',
  },
  select: {
    Icon: SingleSelectIcon,
    Renderer: SelectCell,
    name: 'com.nexio.page-properties.property.select',
  },
  'multi-select': {
    Icon: MultiSelectIcon,
    Renderer: MultiSelectCell,
    name: 'com.nexio.page-properties.property.multi-select',
  },
} as Record<
  string,
  {
