...
export class AtMenuConfigService extends Service {
  ...
  private insertDoc(inlineEditor: NexioInlineEditor, id: string) {
  ...
  private newDocMenuGroup(
    ...
    const customNewDocItems: LinkedMenuItem[] = [
      {
        ...
        icon: NewXxxPageIcon(),
        name: I18n.t('com.nexio.editor.at-menu.create-page', {
      ...
      },
      {
        ...
        name: I18n.t('com.nexio.editor.at-menu.create-edgeless', {
          name: query || I18n.t('Untitled'),
        }),
        action: () => {
          close();
    ...
    const customImportItem: LinkedMenuItem = {
      ...importItem,
      name: I18n.t('com.nexio.editor.at-menu.import'),
      action: () => {
        close();
    ...
    return {
      ...
      name: I18n.t('com.nexio.editor.at-menu.new-doc'),
  ...
  private journalGroup(
    ...
    const items: LinkedMenuItem[] = [
      {
        ...
        name: I18n.t('com.nexio.editor.at-menu.date-picker'),
        action: () => {
          close();
    ...
    return {
      name: I18n.t('com.nexio.editor.at-menu.journal'),
      items,
    };
  }
            ...
            .catch(error => {
              ...
              if (err.is(ErrorNames.MENTION_USER_DOC_ACCESS_DENIED)) {
                ...
                if (canUserManage) {
                  ...
                  notify.error({
                    title: I18n.t('com.nexio.editor.at-menu.access-needed'),
                    message: I18n[
                      'com.nexio.editor.at-menu.access-needed-message'
                    ]({
                      username,
                    }),
                    actions: [
                      {
                        ...
                        onClick: async () => {
                          ...
                          try {
                            ...
                            notify.success({
                              title: I18n.t(
                                'com.nexio.editor.at-menu.invited-and-notified'
                              ),
                            });
                          } catch (error) {
                            const err = UserFriendlyError.fromAny(error);
                  ...
                  notify.error({
                    title: I18n.t(
                      'com.nexio.editor.at-menu.member-not-notified'
                    ),
                    message:
                      I18n[
                        'com.nexio.editor.at-menu.member-not-notified-message'
                      ](),
                  });
                }
