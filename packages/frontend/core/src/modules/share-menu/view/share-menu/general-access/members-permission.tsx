...
const getRoleName = (t: ReturnType<typeof useI18n>, role?: DocRole) => {
  switch (role) {
    ...
    case DocRole.None:
      return t['com.nexio.share-menu.option.permission.no-access']();
    default:
      return '';
  }
};
  ...
  return (
    <div className={styles.rowContainerStyle}>
      <div className={styles.labelStyle}>
        {t['com.nexio.share-menu.option.permission.label']()}
      </div>
      {disabled ? (
...
export const Tips = ({ disable }: { disable?: boolean }) => {
  ...
  return (
    <Tooltip content={t['com.nexio.share-menu.option.permission.tips']()}>
      <InformationIcon
