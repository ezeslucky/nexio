...
export const AboutGroup = () => {
  ...
  return (
    <SettingGroup title={t['com.nexio.mobile.setting.about.title']()}>
      <RowLayout label={t['com.nexio.mobile.setting.about.appVersion']()}>
        {BUILD_CONFIG.isIOS
          ? hiddenVersionVariant(BUILD_CONFIG.appVersion)
          : BUILD_CONFIG.appVersion}
      </RowLayout>

      <RowLayout label={t['com.nexio.mobile.setting.about.editorVersion']()}>
        {BUILD_CONFIG.isIOS
