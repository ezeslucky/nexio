...
import { CalendarXmarkIcon, EditIcon, TodayIcon } from '@canvas/icons/rc';
      ...
      <Guard docId={docRecord.id} permission="Doc_Update">
        {canEdit => (
          <MobileMenuItem
            ...
            disabled={!canEdit}
          >
            {t['com.nexio.page-properties.property.journal-remove']()}
          </MobileMenuItem>
        )}
      </Guard>
...
const ConflictListMenuItem = ({ docRecords }: { docRecords: DocRecord[] }) => {
  ...
  return (
    ...
    >
      {t['com.nexio.m.selector.journal-menu.conflicts']()}
    </MobileMenuSub>
  );
};
