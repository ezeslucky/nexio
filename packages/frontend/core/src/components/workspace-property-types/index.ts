...
export const DateFilterMethod = {
  after: 'com.nexio.filter.after',
  before: 'com.nexio.filter.before',
  between: 'com.nexio.filter.between',
  'last-3-days': 'com.nexio.filter.last 3 days',
  'last-7-days': 'com.nexio.filter.last 7 days',
  'last-15-days': 'com.nexio.filter.last 15 days',
  'last-30-days': 'com.nexio.filter.last 30 days',
  'this-week': 'com.nexio.filter.this week',
  'this-month': 'com.nexio.filter.this month',
  'this-quarter': 'com.nexio.filter.this quarter',
  'this-year': 'com.nexio.filter.this year',
} as const;
...
export const WorkspacePropertyTypes = {
  tags: {
    icon: TagIcon,
    value: TagsValue,
    name: 'com.nexio.page-properties.property.tags',
    uniqueId: 'tags',
    renameable: false,
    description: 'com.nexio.page-properties.property.tags.tooltips',
    filterMethod: {
      'include-all': 'com.nexio.filter.contains all',
      'include-any-of': 'com.nexio.filter.contains one of',
      'not-include-all': 'com.nexio.filter.does not contains all',
      'not-include-any-of': 'com.nexio.filter.does not contains one of',
      'is-not-empty': 'com.nexio.filter.is not empty',
      'is-empty': 'com.nexio.filter.is empty',
    },
    allowInGroupBy: true,
    allowInOrderBy: true,
  ...
  text: {
    icon: TextIcon,
    value: TextValue,
    name: 'com.nexio.page-properties.property.text',
    description: 'com.nexio.page-properties.property.text.tooltips',
    filterMethod: {
      is: 'com.nexio.editCollection.rules.include.is',
      'is-not': 'com.nexio.editCollection.rules.include.is-not',
      'is-not-empty': 'com.nexio.filter.is not empty',
      'is-empty': 'com.nexio.filter.is empty',
    },
    allowInGroupBy: true,
  ...
  number: {
    icon: NumberIcon,
    value: NumberValue,
    name: 'com.nexio.page-properties.property.number',
    description: 'com.nexio.page-properties.property.number.tooltips',
    filterMethod: {
      '<': '<',
      '=': '=',
      '≠': '≠',
  ...
  checkbox: {
    ...
    value: CheckboxValue,
    name: 'com.nexio.page-properties.property.checkbox',
    description: 'com.nexio.page-properties.property.checkbox.tooltips',
    filterMethod: {
      is: 'com.nexio.editCollection.rules.include.is',
      'is-not': 'com.nexio.editCollection.rules.include.is-not',
    },
  ...
  date: {
    icon: DateTimeIcon,
    value: DateValue,
    name: 'com.nexio.page-properties.property.date',
    description: 'com.nexio.page-properties.property.date.tooltips',
    filterMethod: {
      'is-not-empty': 'com.nexio.filter.is not empty',
      'is-empty': 'com.nexio.filter.is empty',
      ...DateFilterMethod,
  ...
  createdBy: {
    ...
    name: 'com.nexio.page-properties.property.createdBy',
    description: 'com.nexio.page-properties.property.createdBy.tooltips',
    allowInGroupBy: true,
    allowInOrderBy: true,
    filterMethod: {
      include: 'com.nexio.filter.contains all',
    },
  ...
  updatedBy: {
    ...
    name: 'com.nexio.page-properties.property.updatedBy',
    description: 'com.nexio.page-properties.property.updatedBy.tooltips',
    allowInGroupBy: true,
    allowInOrderBy: true,
    filterMethod: {
      include: 'com.nexio.filter.contains all',
  ...
  updatedAt: {
    ...
    name: 'com.nexio.page-properties.property.updatedAt',
    description: 'com.nexio.page-properties.property.updatedAt.tooltips',
    renameable: false,
    allowInGroupBy: true,
    allowInOrderBy: true,
    filterMethod: {
  ...
  createdAt: {
    icon: HistoryIcon,
    value: CreateAtValue,
    name: 'com.nexio.page-properties.property.createdAt',
    description: 'com.nexio.page-properties.property.createdAt.tooltips',
    renameable: false,
    allowInGroupBy: true,
    allowInOrderBy: true,
    filterMethod: {
  ...
  docPrimaryMode: {
    ...
    name: 'com.nexio.page-properties.property.docPrimaryMode',
    description: 'com.nexio.page-properties.property.docPrimaryMode.tooltips',
    allowInGroupBy: true,
    allowInOrderBy: true,
    filterMethod: {
      is: 'com.nexio.editCollection.rules.include.is',
  ...
  journal: {
    icon: TodayIcon,
    value: JournalValue,
    name: 'com.nexio.page-properties.property.journal',
    description: 'com.nexio.page-properties.property.journal.tooltips',
    allowInGroupBy: true,
    allowInOrderBy: true,
    filterMethod: {
      is: 'com.nexio.editCollection.rules.include.is',
  ...
  edgelessTheme: {
    ...
    name: 'com.nexio.page-properties.property.edgelessTheme',
    description: 'com.nexio.page-properties.property.edgelessTheme.tooltips',
    showInDocList: 'stack',
    allowInGroupBy: true,
    allowInOrderBy: true,
  ...
  pageWidth: {
    ...
    name: 'com.nexio.page-properties.property.pageWidth',
    description: 'com.nexio.page-properties.property.pageWidth.tooltips',
    showInDocList: 'stack',
    allowInGroupBy: true,
    allowInOrderBy: true,
  ...
  template: {
    icon: TemplateIcon,
    value: TemplateValue,
    name: 'com.nexio.page-properties.property.template',
    renameable: true,
    description: 'com.nexio.page-properties.property.template.tooltips',
    showInDocList: 'stack',
    allowInGroupBy: true,
    allowInOrderBy: true,
