import { MenuItem, PropertyValue, type RadioItem } from '@nexio/component';
  ...
  return (
    <StackProperty icon={<EdgelessIcon />}>
      {edgelessTheme === 'system' || !edgelessTheme
        ? t['com.nexio.themeSettings.auto']()
        : edgelessTheme === 'light'
          ? t['com.nexio.themeSettings.light']()
          : t['com.nexio.themeSettings.dark']()}
    </StackProperty>
  );
};
