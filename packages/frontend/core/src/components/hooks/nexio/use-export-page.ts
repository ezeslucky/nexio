  ...
  const onClickHandler = useAsyncCallback(
    async (type: ExportType) => {
      ...
      try {
        ...
        notify.success({
          title: t['com.nexio.export.success.title'](),
          message: t['com.nexio.export.success.message'](),
        });
      } catch (err) {
        console.error(err);
        notify.error({
          title: t['com.nexio.export.error.title'](),
          message: t['com.nexio.export.error.message'](),
        });
      } finally {
