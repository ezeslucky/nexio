...
export const useEnableCloud = () => {
  ...
  const confirmEnableCloud = useCallback(
    (ws: Workspace, options?: ConfirmEnableCloudOptions) => {
      ...
      openConfirmModal(
        {
          title: t['Enable NEXIO Cloud'](),
          description: t['Enable NEXIO Cloud Description'](),
          cancelText: t['com.nexio.enableNexioCloudModal.button.cancel'](),
          confirmText:
          ...
          confirmButtonOptions: {
            variant: 'primary',
            ['data-testid' as string]: 'confirm-enable-nexio-cloud-button',
          },
          onConfirm: async () =>
