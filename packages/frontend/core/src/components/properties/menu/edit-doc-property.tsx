...
export const EditWorkspacePropertyMenuItems = ({
  ...
  return (
    <>
      ...
      >
        {t['com.nexio.page-properties.create-property.menu.header']()}
        <div className={styles.propertyTypeName}>
          <WorkspacePropertyIcon propertyInfo={propertyInfo} />
          {t[`com.nexio.page-properties.property.${propertyType}`]()}
        </div>
      </div>
      <MenuSeparator />
      <MenuItem
      ...
      <MenuItem
        ...
        onClick={() => {
          confirmModal.openConfirmModal({
            title:
              t['com.nexio.settings.workspace.properties.delete-property'](),
            description: (
              <Trans
                values={{
                  name: name,
                }}
                i18nKey="com.nexio.settings.workspace.properties.delete-property-desc"
              >
