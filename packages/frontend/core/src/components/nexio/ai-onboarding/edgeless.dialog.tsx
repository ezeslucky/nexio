...
export const AIOnboardingEdgeless = () => {
    ...
    const result: NonNullable<Notification['actions']> = [
      {
        ...
        label: (
          <span className={styles.getStartedButtonText}>
            {t['com.nexio.ai-onboarding.edgeless.get-started']()}
          </span>
        ),
        onClick: () => {
      ...
      result.push({
        ...
        label: (
          <span className={styles.purchaseButtonText}>
            {t['com.nexio.ai-onboarding.edgeless.purchase']()}
          </span>
        ),
        onClick: () => {
          goToPricingPlans();
  ...
  useEffect(() => {
    ...
    timeoutRef.current = setTimeout(() => {
      ...
      const id = notify(
        {
          title: t['com.nexio.ai-onboarding.edgeless.title'](),
          message: t['com.nexio.ai-onboarding.edgeless.message'](),
          icon: <AiIcon />,
