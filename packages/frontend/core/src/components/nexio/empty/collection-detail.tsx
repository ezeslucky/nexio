...
import { AllDocsIcon, FilterIcon } from '@canvas/icons/rc';
...
export const EmptyCollectionDetail = ({
  ...
  return (
    <EmptyLayout
      ...
      title={t['com.nexio.empty.collection-detail.title']()}
      description={t['com.nexio.empty.collection-detail.description']()}
      action={
  ...
  return (
    <div className={actionGroup}>
      <ActionButton prefix={<AllDocsIcon />} onClick={openAddDocs}>
        {t['com.nexio.empty.collection-detail.action.add-doc']()}
      </ActionButton>

      <ActionButton prefix={<FilterIcon />} onClick={openAddRules}>
        {t['com.nexio.empty.collection-detail.action.add-rule']()}
      </ActionButton>
    </div>
  );
};
