    ...
    >
      ...
      >
        {showList.includes('whatNew') && (
          <Tooltip content={t['com.nexio.appUpdater.whatsNew']()} side="left">
            <StyledIconWrapper
        ...
        {showList.includes('contact') && (
          <Tooltip content={t['com.nexio.helpIsland.contactUs']()} side="left">
            <StyledIconWrapper
        ...
        {showList.includes('shortcuts') && (
          <Tooltip
            content={t['com.nexio.keyboardShortcuts.title']()}
            side="left"
          >
            <StyledIconWrapper
      ...
      {spread ? (
        ...
        <Tooltip
          content={t['com.nexio.helpIsland.helpAndFeedback']()}
          side="left"
        >
