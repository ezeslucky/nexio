import { Button, Input, Menu, toast } from '@nexio/component';
...
export const CreateOrEditTag = ({
  ...
  const onConfirm = useCallback(() => {
    ...
    if (
      ...
      return toast(t['com.nexio.tags.create-tag.toast.exist']());
    }
    if (!tagMeta) {
      tagList.createTag(tagName.trim(), tagIcon);
      toast(t['com.nexio.tags.create-tag.toast.success']());
      onClose();
      return;
    }
    ...
    toast(t['com.nexio.tags.edit-tag.toast.success']());
    onClose();
    return;
  ...
  return (
    ...
    >
      ...
      <Input
        placeholder={t['com.nexio.tags.create-tag.placeholder']()}
        inputStyle={{ fontSize: 'var(--nexio-font-xs)' }}
        onEnter={onConfirm}
        value={tagName}
