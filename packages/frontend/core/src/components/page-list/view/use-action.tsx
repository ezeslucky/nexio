    ...
    return [
      {
        icon: <FilterIcon />,
        name: 'edit',
        tooltip: t['com.nexio.collection-bar.action.tooltip.edit'](),
        click: () => {
          openEdit(collection);
        },
      },
      {
        icon: <DeleteIcon style={{ color: 'var(--nexio-error-color)' }} />,
        name: 'delete',
        tooltip: t['com.nexio.collection-bar.action.tooltip.delete'](),
        click: onDelete,
      },
    ];
