...
export const container = style({
  width: '100%',
  maxWidth: cssVar('--nexio-editor-width'),
  marginLeft: 'auto',
  marginRight: 'auto',
  paddingLeft: cssVar('--nexio-editor-side-padding', '24'),
  paddingRight: cssVar('--nexio-editor-side-padding', '24'),
  fontSize: cssVar('--nexio-font-base'),
  '@container': {
...
export const title = style({
  ...
  fontSize: '15px',
  lineHeight: '24px',
  color: cssVar('--nexio-text-primary-color'),
});

export const showButton = style({
  height: '28px',
  borderRadius: '8px',
  border: '1px solid ' + cssVar('--nexio-border-color'),
...
globalStyle(`${link} .nexio-reference-title`, {
  borderBottom: 'none',
});
