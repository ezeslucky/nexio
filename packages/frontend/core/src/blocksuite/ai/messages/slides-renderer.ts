...
export class AISlidesRenderer extends WithDisposable(LitElement) {
  ...
  protected override render() {
    return html`<style>
        ...
        .edgeless-container nexio-edgeless-zoom-toolbar-widget,
        edgeless-toolbar {
          display: none;
        }
      ...
      <div class="slides-container">
        <div
          class="edgeless-container nexio-edgeless-viewport"
  ...
  override connectedCallback(): void {
    ...
    doc.load(() => {
      const pageBlockId = doc.addBlock('nexio:page', {});
      doc.addBlock('nexio:surface', {}, pageBlockId);
    });
