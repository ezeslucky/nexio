...
import { CanvasDocEditor, CanvasEdgelessEditor } from './lit-adaper';
...
export const CanvasEditor = (props: EditorProps) => {
  ...
  return (
    <Slot style={{ '--nexio-font-family': fontFamily } as CSSProperties}>
      {isLoading ? (
        ...
        <CanvasEditorImpl key={props.page.id} {...props} />
      )}
    </Slot>
  );
};
