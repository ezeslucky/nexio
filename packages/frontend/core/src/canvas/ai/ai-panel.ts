...
function asCaption<T extends keyof CanvasPresets.AIActions>(
  host: EditorHost,
  id?: T
): AIItemConfig {
  return {
...
function buildPageResponseConfig<T extends keyof CanvasPresets.AIActions>(
...
export function buildFinishConfig<T extends keyof CanvasPresets.AIActions>(
  panel: NexioAIPanelWidget,
  id: T,
  ctx: AIContext
) {
