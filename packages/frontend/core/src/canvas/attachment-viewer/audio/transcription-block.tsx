...
import { LitTranscriptionBlock } from '@nexio/core/canvas/ai/blocks/ai-chat-block/ai-transcription-block';
import type { TranscriptionBlockModel } from '@nexio/core/canvas/ai/blocks/transcription-block/model';
...
export const TranscriptionBlock = ({
  ...
  return (
    <div
      ...
      // draggable + onDragStart to blacklist canvas's default drag behavior for attachment block
      draggable="true"
