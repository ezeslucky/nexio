import { toolbarAIEntryConfig } from '@nexio/core/canvas/ai';
import { AIChatBlockSpec } from '@nexio/core/canvas/ai/blocks';
import { AITranscriptionBlockSpec } from '@nexio/core/canvas/ai/blocks/ai-chat-block/ai-transcription-block';
import { edgelessToolbarAIEntryConfig } from '@nexio/core/canvas/ai/entries/edgeless';
import { imageToolbarAIEntryConfig } from '@nexio/core/canvas/ai/entries/image-toolbar/setup-image-toolbar';
import { AICodeBlockWatcher } from '@nexio/core/canvas/ai/extensions/ai-code';
import { getAIEdgelessRootWatcher } from '@nexio/core/canvas/ai/extensions/ai-edgeless-root';
import { getAIPageRootWatcher } from '@nexio/core/canvas/ai/extensions/ai-page-root';
import { AiSlashMenuConfigExtension } from '@nexio/core/canvas/ai/extensions/ai-slash-menu';
import { CopilotTool } from '@nexio/core/canvas/ai/tool/copilot-tool';
import { aiPanelWidget } from '@nexio/core/canvas/ai/widgets/ai-panel/ai-panel';
import { edgelessCopilotWidget } from '@nexio/core/canvas/ai/widgets/edgeless-copilot';
import {
