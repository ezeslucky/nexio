...
We welcome you to provide us with bug reports via and email at [aurobindolife888@gmail.com](mailto:aurobindolife888@gmail.com) or submit directly on [GitHub](https://github.com/ezeslucky/nexio/security), **we encourage you to submit the relevant information directly via GitHub**. We expect your report to contain at least the following for us to evaluate and reproduce:

1. Using platform and version, for example:

   - macos arm64 0.12.0-canary-202402220729-0868ac6
   - app.nexio.pro 0.12.0-canary-202402220729-0868ac6
