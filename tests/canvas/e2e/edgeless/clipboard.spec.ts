...
test.describe('mime', () => {
  ...
  test('should not paste bad svg', async ({ page }) => {
    expectConsoleMessage(page, 'CanvasError: val does not exist', 'error');
    expectConsoleMessage(page, 'Error: Image sourceId is missing!', 'warning');
...
test.describe('pasting URLs', () => {
  test('pasting github pr url', async ({ page }) => {
    ...
    await expect(
      page.locator('nexio-embed-edgeless-github-block')
    ).toBeVisible();
  });
  ...
  test('pasting internal link', async ({ page }) => {
    ...
    await expect(
      page.locator('nexio-embed-edgeless-linked-doc-block')
    ).toBeVisible();

    await expect(
      page.locator('.nexio-embed-linked-doc-content-title')
