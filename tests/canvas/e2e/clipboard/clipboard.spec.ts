...
test(scoped`pasting internal url`, async ({ page }) => {
  ...
  await expect(page.locator('nexio-reference')).toContainText('test page');
});
...
test(
  ...
  async ({ page }) => {
    ...
    await expect(page.locator('nexio-link')).toContainText('alias');
  }
);
...
test(
  ...
  async ({ page }) => {
    ...
    await expect(page.locator('nexio-reference')).toContainText('alias');
  }
);
