...
export class EditorUtils {
  ...
  public static async getNoteContent(page: Page) {
    const edgelessNode = await page.waitForSelector(
      'nexio-edgeless-note .edgeless-note-page-content'
    );
  ...
  public static async askAIWithCode(
    ...
    await page.locator('nexio-code').blur();
    await page.locator('nexio-code').hover();
    await page.getByTestId('ask-ai-button').click();
    return {
  ...
  public static async askAIWithImage(
    ...
    await page.locator('nexio-slash-menu').getByTestId('Image').click();

    const fileChooser = await fileChooserPromise;
    await fileChooser.setFiles(image);

    await page.locator('nexio-page-image').click();
    await page.getByTestId('ask-ai-button').click();
  ...
  public static async whatAreYourThoughts(page: Page, text: string) {
    const textarea = page.locator(
      'nexio-ai-panel-widget .ai-panel-container textarea'
    );
