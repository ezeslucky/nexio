...
test.describe('Table insertion operations', () => {
  test('should correctly insert columns', async ({ page }) => {
    ...
    const initialCells = table.locator('nexio-table-cell');
    ...
    const cellsAfterRightInsert = table.locator('nexio-table-cell');
    ...
    const cellsAfterLeftInsert = table.locator('nexio-table-cell');
  ...
  test('should correctly insert rows', async ({ page }) => {
    ...
    const cellsAfterBelowInsert = table.locator('nexio-table-cell');
    ...
    const cellsAfterAboveInsert = table.locator('nexio-table-cell');
