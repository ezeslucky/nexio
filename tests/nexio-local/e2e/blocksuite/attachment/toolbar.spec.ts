...
test.describe('Replaces attachment', () => {
  test('should replace attachment in page', async ({ page }) => {
    ...
    const attachment = page.locator('nexio-attachment').first();
    await attachment.click();

    const name = attachment.locator('.nexio-attachment-content-title-text');
  ...
  test('should replace attachment in edgeless', async ({ page }) => {
    ...
    const attachment = page.locator('nexio-edgeless-attachment').first();
    await attachment.click();
